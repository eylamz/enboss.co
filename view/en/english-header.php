...
<button id="colorButton" class="toggle-button">
                <span class="active-mode">
                  <img src="http://localhost/PROJECTS/enboss.co/images/SVG/darkMode.svg" style="vertical-align: middle;" alt="dark mode"></span>
                <span class="inactive-mode">
                <img src="http://localhost/PROJECTS/enboss.co/images/SVG/lightMode.svg" style="vertical-align: middle;" alt="light mode"></span>
                <div class="toggle-circle">
                </div>
              </button>
<!-- <script> // Move Color mode button to the first in menu script
   function moveButton() {
   ...
   window.addEventListener('resize', moveButton);
     ...
     <div class="nav-icons">
       <a class="search-icon"><button id="search-icon" aria-label="search"><svg id="my-svg" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 23.37 23.37">
        <defs>
          <style>
        ...
        <g id="a"/>
        <g id="b">
          <g id="c"><!-- Designed by Eylam Zrihan @eylamz -->
...
<script> // Dark Mode switcher  
  ...
  document.addEventListener('DOMContentLoaded', function() {
    if (prefersDark) {
      ...
      toggleCircle.style.backgroundColor = 'var(--ne-logo)';
      colorButton.classList.add('active');
      colorButton.style.backgroundColor = 'var(--ne-light-grey)';
  ...
  colorButton.addEventListener('click', function() {
    ...
    if (isColorChanged) {
      toggleButton.style.backgroundColor = 'var(--text-light)';
      isColorChanged = false;
    } else {
      toggleButton.style.backgroundColor = 'var(--ne-light-grey)';
      isColorChanged = true;
    }
    ...
    if (isActive) {
      ...
      toggleCircle.style.backgroundColor = '#f0f2f4';
  ...
  if (prefersDark) {
    ...
    colorButton.style.backgroundColor = 'var(--text-light)';
    updateMetaThemeColor('#f0f2f4');
  }
