...
<body>
     <!-- Header Section -->
 <header class="header-he" id="header">
  <div class="navi-he">
    <nav class="navbar container">
      <a href="/he" class="brand" aria-label="enboss home">
       ...
       <div class="menu" id="menu" aria-label="navigation links">
        <ul class="menu-inner" id="in-menu" aria-label="navigation links">
           <li class="menu-item"><a href="/he" class="menu-link" aria-label="עמוד הבית">בית</a></li>
           <li class="menu-item"><a href="/he/skateparks" class="menu-link" aria-label="עמוד סקייטפארקים">פארקים</a></li>
...
<svg id="my-svg-he" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 23.37 23.37">       <defs>
       ...
       <a class="translate" href="/en"><button class="menu-block" id="urlChanger" aria-label="translate to english page">
       ...
       burgerMenu.addEventListener("click", () => {
          ...
          if (svgElementHe.classList.contains('clicked')) {
            ...
            svgElementHe.classList.add('disable');
              ...
              // Remove active class from navi
          naviHe.classList.remove('active');
              // Remove active class from searchBox
          searchBoxHe.classList.remove('active');
              // Clear input box and hide search results
          inputBox.value = '';
