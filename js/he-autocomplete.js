...
'Tel Aviv - Ramat HaHayal': '/en/skateparks/tel-aviv-2',
...
"מודיעין פארק מוריה": '/he/skateparks/modiin-moriah-park',
...
resultsBox.innerHTML = '<ul>' + content.join('') + '</ul>';
  ...
  const svgElementHe = document.querySelector('#my-svg-he');
  ...
  const searchBoxHe = document.querySelector('.search-box-he');
  const naviHe = document.querySelector('.navi-he');
