...
<head>
  ...
  <title>Hadera | ENBOSS</title>
  <meta name="description" content="Experience Thrilling Adventures at Hadera Skatepark: Embrace the Thrill of Extreme Sports. Get ready to amp up your adrenaline at Hadera Skatepark. Whether you're into skateboarding, BMX biking, or inline skating, this dynamic playground offers endless opportunities for extreme sports enthusiasts. Join the action, unleash your skills, and let the excitement take over.">  

  <meta property="og:type" content="website">
  <meta property="og:title" content="Hadera Skatepark">
  <meta property="og:image" content="http://www.enboss.co/images/ParkFav/hadera.png">
  <meta property="og:image:secure_url" content="https://www.enboss.co/images/ParkFav/hadera.png">
  <meta property="og:description" content="Unleash Your Adrenaline at Hadera Skatepark: Embrace Extreme Sports Thrills!">  
  <meta property="og:url" content="http://www.enboss.co/en/skateparks/hadera">
  <meta property="og:site_name" content="ENBOSS">
  <link rel="icon" href="/svg/EnbossFavIcon.svg">
  <meta property="og:locale" content="en_US">
  <meta name="keywords" content="israel, skatepark, rollerblade, skate, hebrew, hadera, roller, israeli, scoot, jerusalem, tel aviv, middle east, enboss.co">
...
<div class="parkHead">
  <h1>Hadera</h1>
      ...
      <div class="slideshowDiv" >
        ...
        <div class="mySlides">
          <picture>
            <source media="(max-width: 768px)" srcset="/images/Park768-webp/hadera1.webp">
            <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/hadera1.webp">
            <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/hadera1.webp">
            <img src="/images/ParkGallery-webp/hadera1.webp" alt="hadera skatepark" />
        </picture>
        ...
        <div class="mySlides">
          <picture>
            <source media="(max-width: 768px)" srcset="/images/Park768-webp/hadera2.webp">
            <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/hadera2.webp">
            <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/hadera2.webp">
            <img src="/images/ParkGallery-webp/hadera2.webp" alt="hadera skatepark" />
        </picture>
        ...
        <div class="mySlides">
          <picture>
            <source media="(max-width: 768px)" srcset="/images/Park768-webp/hadera3.webp">
            <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/hadera3.webp">
            <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/hadera3.webp">
            <img src="/images/ParkGallery-webp/hadera3.webp" alt="hadera skatepark" />
        </picture>
        ...
        <div class="mySlides">
          <picture>
            <source media="(max-width: 768px)" srcset="/images/Park768-webp/hadera4.webp">
            <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/hadera4.webp">
            <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/hadera4.webp">
            <img src="/images/ParkGallery-webp/hadera4.webp" alt="hadera skatepark" />
        </picture>
        ...
        <div class="mySlides">
          <picture>
            <source media="(max-width: 768px)" srcset="/images/Park768-webp/hadera5.webp">
            <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/hadera5.webp">
            <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/hadera5.webp">
            <img src="/images/ParkGallery-webp/hadera5.webp" alt="hadera skatepark" />
        </picture>
        ...
        <div class="mySlides">
          <picture>
            <source media="(max-width: 768px)" srcset="/images/Park768-webp/hadera6.webp">
            <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/hadera6.webp">
            <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/hadera6.webp">
            <img src="/images/ParkGallery-webp/hadera6.webp" alt="hadera skatepark" />
        </picture>
        ...
        <div class="mySlides">
          <picture>
            <source media="(max-width: 768px)" srcset="/images/Park768-webp/hadera7.webp">
            <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/hadera7.webp">
            <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/hadera7.webp">
            <img src="/images/ParkGallery-webp/hadera7.webp" alt="hadera skatepark" />
        </picture>
        ...
        <div class="mySlides">
          <picture>
            <source media="(max-width: 768px)" srcset="/images/Park768-webp/hadera8.webp">
            <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/hadera8.webp">
            <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/hadera8.webp">
            <img src="/images/ParkGallery-webp/hadera8.webp" alt="hadera skatepark" />
        </picture>
        ...
        <div class="mySlides">
          <picture>
            <source media="(max-width: 768px)" srcset="/images/Park768-webp/hadera9.webp">
            <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/hadera9.webp">
            <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/hadera9.webp">
            <img src="/images/ParkGallery-webp/hadera9.webp" alt="hadera skatepark" />
        </picture>
        ...
        <div class="mySlides">
          <picture>
            <source media="(max-width: 768px)" srcset="/images/Park768-webp/hadera10.webp">
            <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/hadera10.webp">
            <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/hadera10.webp">
            <img src="/images/ParkGallery-webp/hadera10.webp" alt="hadera skatepark" />
        </picture>
        ...
        <div class="mySlides">
          <picture>
            <source media="(max-width: 768px)" srcset="/images/Park768-webp/hadera11.webp">
            <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/hadera11.webp">
            <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/hadera11.webp">
            <img src="/images/ParkGallery-webp/hadera11.webp" alt="hadera skatepark" />
        </picture>
        ...
        <div class="mySlides">
          <picture>
            <source media="(max-width: 768px)" srcset="/images/Park768-webp/hadera12.webp">
            <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/hadera12.webp">
            <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/hadera12.webp">
            <img src="/images/ParkGallery-webp/hadera12.webp" alt="hadera skatepark" />
        </picture>
...
<div class="list-img">
  <ul> 
    ...
    <hr>
      ...
      <li>From sunset untill 23:00.</li>
      <hr>
      <li><strong>Address :</strong></li>
      <li>HaNevel Street 30, Hadera.</li>
      <hr>
...
<g>
  ...
  <br>
  <span><strong>Address :</strong><br>HaNevel Street 30, Hadera.​</span>
</div>
<div class="social-maps"> 
  <div class="map-icon">
  <a href="https://waze.com/ul/hsvbb6rq9j" target="_blank" class="waze" id="hadera-waze">
     <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
     <g>
...
<div class="map-icon">
  <a href="https://www.google.com/maps/place/skate+park+hadera+%D7%A1%D7%A7%D7%99%D7%99%D7%98+%D7%A4%D7%90%D7%A8%D7%A7+%D7%97%D7%93%D7%A8%D7%94,+HaNevel+St,+Hadera%E2%80%AD/@32.4274127,34.9139543,16z/data=!4m14!1m7!3m6!1s0x151d13accd277f15:0x907e3fd3d9e59534!2zSnVzdCBndWlkZSwg15TXoNeR15wgMzBoYSBuZXZlbCwgSGFkZXJh!8m2!3d32.4274127!4d34.9139543!16s%2Fg%2F11cjg6p4ln!3m5!1s0x151d137ae069508f:0xd3211401a327b53b!8m2!3d32.427627!4d34.9124604!16s%2Fg%2F11sy_sn4lq?hl=en-IL&gl=il" target="_blank" class="google" id="hadera-google">
   <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
      viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
   <style type="text/css">
     .st22{fill:auto;}
...
<div class="map-icon">
 <a href="https://maps.apple.com/?ll=32.427734,34.913104&q=Dropped%20Pin&t=h" target="_blank" class="apple" id="hadera-apple">
     <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
     <style type="text/css">
       .st20{fill:auto;}
...
<div class="vid-map">
  ...
  <div class="google-map">
    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d26941.50236527835!2d34.913207!3d32.42752!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x151d137ae069508f%3A0xd3211401a327b53b!2zc2thdGUgcGFyayBoYWRlcmEg16HXp9eZ15nXmCDXpNeQ16jXpyDXl9eT16jXlA!5e0!3m2!1sen!2sus!4v1684506195093!5m2!1sen!2sus" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
</div>
 <!--   otherParks Section    -->
