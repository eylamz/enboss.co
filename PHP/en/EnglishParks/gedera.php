...
<head>
  ...
  <title>Gedera | ENBOSS</title>
  <meta name="description" content="Unleash Your Extreme Sports Passion. Experience the thrill and excitement at Gedera Skatepark, where adrenaline meets creativity. Push your limits on ramps, rails, and obstacles designed to challenge even the most daring athletes. Join fellow extreme sports enthusiasts and embark on a journey of adrenaline-fueled fun at Gedera Skatepark.">

  <meta property="og:type" content="website">
  <meta property="og:title" content="Gedera Skatepark">
  <meta property="og:image" content="http://www.enboss.co/images/ParkFav/gedera.png">
  <meta property="og:image:secure_url" content="https://www.enboss.co/images/ParkFav/gedera.png">
  <meta property="og:description" content="Fuel Your Passion: Thrilling Extreme Sports at Gedera Skatepark.">  
  <meta property="og:url" content="http://www.enboss.co/en/skateparks/gedera">
  <meta property="og:site_name" content="ENBOSS">
  <link rel="icon" href="/svg/EnbossFavIcon.svg">
  <meta property="og:locale" content="en_US">
  <meta name="keywords" content="israel, skatepark, rollerblade, skate, hebrew, gedera, roller, israeli, scoot, jerusalem, tel aviv, middle east, enboss.co">
...
.<main class="parkMain body-move">
  ...
  <div class="parkHead">
    <h1>Gedera</h1>
        ...
        <div class="slideshowDiv" >
            ...
            <div class="mySlides">
                <picture>
                    <source media="(max-width: 768px)" srcset="/images/Park768-webp/gedera.webp">
                    <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/gedera.webp">
                    <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/gedera.webp">
                    <img src="/images/ParkGallery-webp/gedera.webp" alt="gedera skatepark" />
                </picture>
            ...
            <div class="mySlides">
              <picture>
                  <source media="(max-width: 768px)" srcset="/images/Park768-webp/gedera1.webp">
                  <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/gedera1.webp">
                  <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/gedera1.webp">
                  <img src="/images/ParkGallery-webp/gedera1.webp" alt="gedera skatepark" />
              </picture>
            ...
            <div class="mySlides">
              <picture>
                  <source media="(max-width: 768px)" srcset="/images/Park768-webp/gedera2.webp">
                  <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/gedera2.webp">
                  <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/gedera2.webp">
                  <img src="/images/ParkGallery-webp/gedera2.webp" alt="gedera skatepark" />
              </picture>
            ...
            <div class="mySlides">
              <picture>
                  <source media="(max-width: 768px)" srcset="/images/Park768-webp/gedera3.webp">
                  <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/gedera3.webp">
                  <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/gedera3.webp">
                  <img src="/images/ParkGallery-webp/gedera3.webp" alt="gedera skatepark" />
              </picture>
            ...
            <div class="mySlides">
              <picture>
                  <source media="(max-width: 768px)" srcset="/images/Park768-webp/gedera4.webp">
                  <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/gedera4.webp">
                  <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/gedera4.webp">
                  <img src="/images/ParkGallery-webp/gedera4.webp" alt="gedera skatepark" />
              </picture>
            ...
            <div class="mySlides">
              <picture>
                  <source media="(max-width: 768px)" srcset="/images/Park768-webp/gedera5.webp">
                  <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/gedera5.webp">
                  <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/gedera5.webp">
                  <img src="/images/ParkGallery-webp/gedera5.webp" alt="gedera skatepark" />
              </picture>
            ...
            <div class="mySlides">
              <picture>
                  <source media="(max-width: 768px)" srcset="/images/Park768-webp/gedera6.webp">
                  <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/gedera6.webp">
                  <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/gedera6.webp">
                  <img src="/images/ParkGallery-webp/gedera6.webp" alt="gedera skatepark" />
              </picture>
  ...
  <g>
    ...
    <br>
    <span><strong>Address :</strong><br>Sapir St 34, Gedera.​</span>
  </div>
  <div class="social-maps"> 
    <div class="map-icon">
      <a href="https://waze.com/ul/hsv8szkvvv" target="_blank" class="waze" id="gedera-waze">
       <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
       <g>
  ...
  <div class="map-icon">
    <a href="https://goo.gl/maps/Ns9KY4Gj7V2697Zd7" target="_blank" class="google" id="gedera-google">
     <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
     <style type="text/css">
       .st22{fill:auto;}
  ...
  <div class="map-icon">
    <a href="https://maps.apple.com/?ll=31.800270,34.777771&q=Dropped%20Pin&t=m" target="_blank" class="apple" id="gedera-apple">
       <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
       <style type="text/css">
         .st20{fill:auto;}
  ...
  <div class="vid-map">
  <div class="iconBox2">
  <iframe width="560" height="315" src="https://www.youtube.com/embed/hzZ8HsFCksg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>  </div>
  <div class="google-map">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3417.779070912858!2d35.03610337614852!3d31.060249369729693!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x150247a46318da8f%3A0x3aa3b67855523a48!2z15TXoden15nXmdeY16TXkNeo16cg16nXnCDXmNecINeR15PXmdee15XXoNeU!5e0!3m2!1sen!2sil!4v1683473059314!5m2!1sen!2sil" width="560" height="315" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>  
    </div>
</div>
</main>
