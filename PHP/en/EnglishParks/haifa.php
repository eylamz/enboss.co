...
<head>
  ...
  <title>Haifa | ENBOSS</title>
  <meta name="description" content="Unleash Your Extreme Sports Skills at Haifa Skatepark: Shred and Soar in a Coastal Playground. Get ready to push your limits and experience the thrill of extreme sports at Haifa Skatepark. From skateboarding to BMX biking and inline skating, this adrenaline-fueled destination is a paradise for all extreme sports enthusiasts.">  

  <meta property="og:type" content="website">
  <meta property="og:title" content="Haifa Skatepark">
  <meta property="og:image" content="http://www.enboss.co/images/ParkFav/haifa.png">
  <meta property="og:image:secure_url" content="https://www.enboss.co/images/ParkFav/haifa.png">
  <meta property="og:description" content="Unleash Your Extreme Skills in a Coastal Playground!">  
  <meta property="og:url" content="http://www.enboss.co/en/skateparks/haifa">
  <meta property="og:site_name" content="ENBOSS">
  <link rel="icon" href="/svg/EnbossFavIcon.svg">
  <meta property="og:locale" content="en_US">
  <meta name="keywords" content="israel, skatepark, rollerblade, skate, hebrew, haifa, roller, israeli, scoot, jerusalem, tel aviv, middle east, enboss.co">
  ...
  <main class="parkMain body-move">
    <div class="parkHead">
      ...
      <div class="slideshowDiv" >
        ...
        <div class="mySlides">
          <picture>
            <source media="(max-width: 768px)" srcset="/images/Park768-webp/haifa.webp">
            <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/haifa.webp">
            <img src="/images/ParkGallery-webp/haifa.webp" alt="haifa skatepark" />
        </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/haifa1.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/haifa1.webp">
                <img src="/images/ParkGallery-webp/haifa1.webp" alt="haifa skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/haifa2.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/haifa2.webp">
                <img src="/images/ParkGallery-webp/haifa2.webp" alt="haifa skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/haifa3.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/haifa3.webp">
                <img src="/images/ParkGallery-webp/haifa3.webp" alt="haifa skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/haifa4.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/haifa4.webp">
                <img src="/images/ParkGallery-webp/haifa4.webp" alt="haifa skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/haifa5.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/haifa5.webp">
                <img src="/images/ParkGallery-webp/haifa5.webp" alt="haifa skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/haifa6.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/haifa6.webp">
                <img src="/images/ParkGallery-webp/haifa6.webp" alt="haifa skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/haifa7.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/haifa7.webp">
                <img src="/images/ParkGallery-webp/haifa7.webp" alt="haifa skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/haifa8.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/haifa8.webp">
                <img src="/images/ParkGallery-webp/haifa8.webp" alt="haifa skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/haifa9.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/haifa9.webp">
                <img src="/images/ParkGallery-webp/haifa9.webp" alt="haifa skatepark" />
            </picture>
...
<div class="list-img">
  <ul>
    ...
    <li><strong>Fri :</strong> 09:00-19:00</li>
    <li><strong>Sat and Holidays :</strong> 09:00-23:00</li>
    <hr>
    <li><strong>* </strong>In the winter the park closes an hour earlier.</li>
    <hr>
    <li><strong>Address :</strong></li>
    <li>Haifa Skatepark, Hecht Park, Haifa.</li>
    <hr>
...
<g>
  ...
  <br>
  <span><strong>Address :</strong><br>Haifa Skatepark, Hecht Park, Haifa.</span>
</div>
<div class="social-maps"> 
    <div class="map-icon">
    <a href="https://waze.com/ul/hsvbferqut" target="_blank" class="waze" id="haifa-waze">
       <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
       <g>
  ...
  <div class="map-icon">
    <a href="https://maps.google.com/?q=Skatepark%20of%20Haifa,%20Haifa&ftid=0x151dbb8f2d88d045:0x77aee3af8a0a270f&hl=en-IL&gl=il&entry=gps&g_st=ic" target="_blank" class="google" id="haifa-google">
     <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
     <style type="text/css">
       .st22{fill:auto;}
  ...
  <div class="map-icon">
   <a href="https://maps.apple.com/?address=Hahagana%20Road,%20Haifa,%20Israel&auid=6817445970353088644&ll=32.822588,34.956232&lsp=9902&q=Skatepark&_ext=CioKBAgEEEsKBAgFEAMKBAgGEBIKBAgKEAEKBAhSEAcKBAhVEA4KBAhZEAESJCmujQ06s2hAQDEaaXCrwnlBQDksYzOW2WlAQEHaXVTzIHtBQA%3D%3D&t=h" target="_blank" class="apple" id="haifa-apple">
       <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
       <style type="text/css">
         .st20{fill:auto}
