...
<head>
  ...
  <title>Lod | ENBOSS</title>
  <meta name="description" content="Experience the Thrills at Lod Skatepark: Unleash Your Skills in an Action-Packed Playground. Whether you're a skateboarder, BMX enthusiast, or rollerblader, Lod Skatepark is your ultimate destination for heart-pounding excitement. With its dynamic features and exhilarating ramps, this park sets the stage for epic tricks and unforgettable moments. Get ready to ignite your passion for extreme sports and make unforgettable memories at Lod Skatepark.">  

  <meta property="og:type" content="website">
  <meta property="og:title" content="Lod Skatepark">
  <meta property="og:image" content="http://www.enboss.co/images/ParkFav/lod.png">
  <meta property="og:image:secure_url" content="https://www.enboss.co/images/ParkFav/lod.png">
  <meta property="og:description" content="Experience the Thrills: Unleash Your Skills in an Action-Packed Playground.">  
  <meta property="og:url" content="http://www.enboss.co/en/skateparks/lod">
  ...
  <meta name="keywords" content="israel, skatepark, rollerblade, skate, hebrew, lod, roller, israeli, scoot, jerusalem, tel aviv, middle east, enboss.co">
...
<main class="parkMain body-move">
  ...
  <div class="parkHead">
    <h1>Lod</h1>
        ...
        <div class="slideshowDiv" >
          ...
          <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/lod1.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/lod1.webp">
                <img src="/images/ParkGallery-webp/lod1.webp" alt="lod skatepark" />
            </picture>
          ...
          <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/lod2.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/lod2.webp">
                <img src="/images/ParkGallery-webp/lod2.webp" alt="lod skatepark" />
            </picture>
          ...
          <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/lod3.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/lod3.webp">
                <img src="/images/ParkGallery-webp/lod3.webp" alt="lod skatepark" />
            </picture>
          ...
          <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/lod4.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/lod4.webp">
                <img src="/images/ParkGallery-webp/lod4.webp" alt="lod skatepark" />
            </picture>
          ...
          <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/lod5.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/lod5.webp">
                <img src="/images/ParkGallery-webp/lod5.webp" alt="lod skatepark" />
            </picture>
          ...
          <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/lod6.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/lod6.webp">
                <img src="/images/ParkGallery-webp/lod6.webp" alt="lod skatepark" />
            </picture>
          ...
          <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/lod7.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/lod7.webp">
                <img src="/images/ParkGallery-webp/lod7.webp" alt="lod skatepark" />
            </picture>
  ...
  <g>
    ...
    <br>
    <span><strong>Address :</strong><br>Admonit Street 101, Lod.​</span>
  </div>
  <div class="social-maps"> 
    <div class="map-icon">
      <a href="https://waze.com/ul/hsv8vcdz9s" target="_blank" class="waze" id="lod-waze">
       <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
       <g>
  ...
  <div class="map-icon">
    <a href="https://maps.app.goo.gl/JAUMKJCApY3mYDb37?g_st=iw" target="_blank" class="google" id="lod-google">
     <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
     <style type="text/css">
       .st22{fill:auto;}
  ...
  <div class="map-icon">
    <a href="https://maps.apple.com/?address=Admonit%20Street%20101,%20Lod,%20Israel&ll=31.961270,34.879567&q=Admonit%20Street%20101&t=h" target="_blank" class="apple" id="lod-apple">
       <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
       <style type="text/css">
         .st20{fill:auto;}
  ...
  <div class="vid-map">
    ...
    <div class="google-map">
      <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d27079.377978180808!2d34.880627!3d31.963006!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1502cb66c58cbf51%3A0x82a25d5cf177a380!2sLodboard!5e0!3m2!1sen!2sus!4v1684697252162!5m2!1sen!2sus" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
  </div>
