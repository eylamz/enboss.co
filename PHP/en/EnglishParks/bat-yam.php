...
<head>
  ...
  <title>Bat Yam | ENBOSS</title>
  <meta name="description" content="Experience the Thrill of Bat Yam Skatepark. Bat Yam Skatepark is a dynamic and exciting destination for skateboarders, BMX riders, and rollerbladers. With its well-designed ramps, rails, and obstacles, this skatepark offers a thrilling experience for extreme sports enthusiasts. Join the community of like-minded thrill-seekers and push your limits at Bat Yam Skatepark.">

  <meta property="og:type" content="website">
  <meta property="og:title" content="Bat Yam Skatepark">
  <meta property="og:image" content="http://www.enboss.co/images/ParkFav/bat-yam.png">
  <meta property="og:image:secure_url" content="https://www.enboss.co/images/ParkFav/bat-yam.png">
  <meta property="og:description" content="Experience the Thrill of Extreme Sports in Bat Yam.">
  <meta property="og:url" content="http://www.enboss.co/en/skateparks/bat-yam">
  <meta property="og:site_name" content="ENBOSS">
  <link rel="icon" href="/svg/EnbossFavIcon.svg">
  <meta property="og:locale" content="en_US">
  <meta name="keywords" content="israel, skatepark, rollerblade, skate, hebrew, bat yam, roller, israeli, scoot, jerusalem, tel aviv, middle east, enboss.co">
      ...
      <div class="slideshowDiv" >
        ...
        <div class="mySlides">
            <picture>
                ...
                <source media="(max-width: 769px)" srcset="/images/ParkGallery-webp/bat-yam.webp">
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/bat-yam1.webp">
                <source media="(max-width: 769px)" srcset="/images/ParkGallery-webp/bat-yam1.webp">
                <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/bat-yam1.webp">
                <img src="/images/ParkGallery-webp/bat-yam1.webp" alt="bat yam skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/bat-yam2.webp">
                <source media="(max-width: 769px)" srcset="/images/ParkGallery-webp/bat-yam2.webp">
                <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/bat-yam2.webp">
                <img src="/images/ParkGallery-webp/bat-yam2.webp" alt="bat yam skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/bat-yam3.webp">
                <source media="(max-width: 769px)" srcset="/images/ParkGallery-webp/bat-yam3.webp">
                <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/bat-yam3.webp">
                <img src="/images/ParkGallery-webp/bat-yam3.webp" alt="bat yam skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/bat-yam4.webp">
                <source media="(max-width: 769px)" srcset="/images/ParkGallery-webp/bat-yam4.webp">
                <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/bat-yam4.webp">
                <img src="/images/ParkGallery-webp/bat-yam4.webp" alt="bat yam skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/bat-yam5.webp">
                <source media="(max-width: 769px)" srcset="/images/ParkGallery-webp/bat-yam5.webp">
                <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/bat-yam5.webp">
                <img src="/images/ParkGallery-webp/bat-yam5.webp" alt="bat yam skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/bat-yam6.webp">
                <source media="(max-width: 769px)" srcset="/images/ParkGallery-webp/bat-yam6.webp">
                <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/bat-yam6.webp">
                <img src="/images/ParkGallery-webp/bat-yam6.webp" alt="bat yam skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/bat-yam7.webp">
                <source media="(max-width: 769px)" srcset="/images/ParkGallery-webp/bat-yam7.webp">
                <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/bat-yam7.webp">
                <img src="/images/ParkGallery-webp/bat-yam7.webp" alt="bat yam skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/bat-yam8.webp">
                <source media="(max-width: 769px)" srcset="/images/ParkGallery-webp/bat-yam8.webp">
                <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/bat-yam8.webp">
                <img src="/images/ParkGallery-webp/bat-yam8.webp" alt="bat yam skatepark" />
            </picture>
...
<g>
  ...
  <br>
  <span><strong>Address :</strong><br>There is no street for arrival, please follow the navigation links below.</span>
</div>
<div class="social-maps"> 
    <div class="map-icon">
  <a href="https://waze.com/ul/hsv8wn6y83" target="_blank" class="waze" id="bat-yam-waze">
     <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
     <g>
...
<div class="map-icon">
  <a href="https://goo.gl/maps/kzBTKcVfVtRPuL2F8" target="_blank" class="google" id="bat-yam-google">
   <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
      viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
   <style type="text/css">
     .st22{fill:auto;}
...
<div class="map-icon">
 <a href="https://maps.apple.com/?ll=32.007322,34.736911&q=Dropped%20Pin&t=h" target="_blank" class="apple" id="bat-yam-apple">
     <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
     <style type="text/css">
       .st20{fill:auto;}
