...
<head>
  ...
  <title>Giv'atayim | ENBOSS</title>
  <meta name="description" content="Experience the Thrill of Giv'atayim Skatepark. Giv'atayim Skatepark is a dynamic and exciting destination for skateboarders, BMX riders, and rollerbladers. With its well-designed ramps, rails, and obstacles, this skatepark offers a thrilling experience for extreme sports enthusiasts. Join the community of like-minded thrill-seekers and push your limits at Giv'atayim Skatepark.">

  <meta property="og:type" content="website">
  <meta property="og:title" content="Giv'atayim Skatepark">
  <meta property="og:image" content="http://www.enboss.co/images/ParkFav/givatayim.png">
  <meta property="og:image:secure_url" content="https://www.enboss.co/images/ParkFav/givatayim.png">
  <meta property="og:description" content="Experience the Thrill of Extreme Sports in Giv'atayim.">
  <meta property="og:url" content="http://www.enboss.co/en/skateparks/givatayim">
  <meta property="og:site_name" content="ENBOSS">
  <link rel="icon" href="/svg/EnbossFavIcon.svg">
  <meta property="og:locale" content="en_US">
  <meta name="keywords" content="israel, skatepark, rollerblade, skate, hebrew, givatayim, roller, israeli, scoot, jerusalem, tel aviv, middle east, enboss.co">
...
<body class="parkBody">
  ...
  <h1>Giv'atayim</h1>
      ...
      <div class="slideshowDiv" >
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/givatayim.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/givatayim.webp">
                <img src="/images/ParkGallery-webp/givatayim.webp" alt="givatayim skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/givatayim1.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/givatayim1.webp">
                <img src="/images/ParkGallery-webp/givatayim1.webp" alt="givatayim skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/givatayim2.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/givatayim2.webp">
                <img src="/images/ParkGallery-webp/givatayim2.webp" alt="givatayim skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/givatayim3.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/givatayim3.webp">
                <img src="/images/ParkGallery-webp/givatayim3.webp" alt="givatayim skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/givatayim4.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/givatayim4.webp">
                <img src="/images/ParkGallery-webp/givatayim4.webp" alt="givatayim skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/givatayim5.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/givatayim5.webp">
                <img src="/images/ParkGallery-webp/givatayim5.webp" alt="givatayim skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/givatayim6.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/givatayim6.webp">
                <img src="/images/ParkGallery-webp/givatayim6.webp" alt="givatayim skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/givatayim7.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/givatayim7.webp">
                <img src="/images/ParkGallery-webp/givatayim7.webp" alt="givatayim skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/givatayim8.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/givatayim8.webp">
                <img src="/images/ParkGallery-webp/givatayim8.webp" alt="givatayim skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/givatayim9.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/givatayim9.webp">
                <img src="/images/ParkGallery-webp/givatayim9.webp" alt="givatayim skatepark" />
            </picture>
...
<div class="list-img">
  <ul>
    ...
    <li><strong>Sun-Fri :</strong> 14:00-21:30</li>
    <li><strong>Sat and Holidays :</strong> 12:00-21:30</li>
    <hr>
    <li><strong>Address :</strong></li>
      <li></li>Derech Yitshak Rabin, Giv'atayim. (Infront of Giv'atayim Mall, under the bridge).​</li>
    <hr>
...
<g>
  ...
  <br>
  <span><strong>Address :</strong><br>Derech Yitshak Rabin, Giv'atayim. (Infront of Giv'atayim Mall, under the bridge).</span>
</div>
<div class="social-maps"> 
    <div class="map-icon">
  <a href="https://waze.com/ul/hsv8y2jkfp" target="_blank" class="waze" id="givatayim-waze">
     <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
     <g>
...
<div class="map-icon">
  <a href="https://maps.google.com/?q=Skateboard%20Park%20Giv%27atayim,%20Derech%20Yitshak%20Rabin,%20Giv%27atayim&ftid=0x151d4ba96a870623:0xfb8ad943700ac9c3&hl=en-IL&gl=il&entry=gps&g_st=ic" target="_blank" class="google" id="givatayim-google">
   <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
      viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
   <style type="text/css">
     .st22{fill:auto;}
...
<div class="map-icon">
 <a href="https://maps.apple.com/?address=Hahistadrut%20Street%201,%20Givatayim%205358401,%20Israel&auid=6599890599930992777&ll=32.065301,34.811532&lsp=9902&q=%D7%A1%D7%A7%D7%99%D7%99%D7%98%D7%A4%D7%90%D7%A8%D7%A7&_ext=CioKBAgEEEsKBAgFEAMKBAgGEBIKBAgKEAAKBAhSEAcKBAhVEBAKBAhZEAYSJil/HIP10AdAQDGsHNtFHWdBQDn98ahR9whAQEH21dSfeGhBQFAE&t=h" target="_blank" class="apple" id="givatayim-apple">
     <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
     <style type="text/css">
       .st20{fill:auto;}
...
<div class="vid-map">
  ...
  <div class="google-map">
    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d27049.150741743746!2d34.811522!3d32.065358!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x151d4ba96a870623%3A0xfb8ad943700ac9c3!2sSkateboard%20Park%20Giv&#39;atayim!5e0!3m2!1sen!2sus!4v1684617897738!5m2!1sen!2sus%22 width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>  </div>
    </div>
</div>
