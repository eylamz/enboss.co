...
<head>
  ...
  <title>Tel Aviv | ENBOSS</title>
  <meta name="description" content="Unleash Your Adventurous Spirit in Tel Aviv: The Hub for Extreme Sports. Dive into a world of exciting skateparks, thrilling activities, and a vibrant community of adrenaline junkies. Get ready to push your limits and create unforgettable memories in Tel Aviv!">  

  <meta property="og:type" content="website">
  <meta property="og:title" content="Tel Aviv Skatepark">
  <meta property="og:image" content="http://www.enboss.co/images/ParkFav/tel-aviv.png">
  <meta property="og:image:secure_url" content="https://www.enboss.co/images/ParkFav/tel-aviv.png">
...
<div class="parkHead">
  <h1>Tel Aviv</h1>
      ...
      <div class="slideshowDiv" >
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/tel-aviv.webp">
                <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/tel-aviv.webp">
                <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/tel-aviv.webp">
                <img src="/images/ParkGallery-webp/tel-aviv.webp" alt="tel aviv skatepark" />
            </picture>
            <div class="number">1 / 14</div>
        </div>
    
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/tel-aviv1.webp">
                <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/tel-aviv1.webp">
                <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/tel-aviv1.webp">
                <img src="/images/ParkGallery-webp/tel-aviv1.webp" alt="tel aviv skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/tel-aviv2.webp">
                <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/tel-aviv2.webp">
                <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/tel-aviv2.webp">                
                <img src="/images/ParkGallery-webp/tel-aviv2.webp" alt="tel aviv skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/tel-aviv3.webp">
                <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/tel-aviv3.webp">
                <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/tel-aviv3.webp">                
                <img src="/images/ParkGallery-webp/tel-aviv3.webp" alt="tel aviv skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/tel-aviv4.webp">
                <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/tel-aviv4.webp">
                <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/tel-aviv4.webp">                
                <img src="/images/ParkGallery-webp/tel-aviv4.webp" alt="tel aviv skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/tel-aviv5.webp">
                <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/tel-aviv5.webp">
                <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/tel-aviv5.webp">
                <img src="/images/ParkGallery-webp/tel-aviv5.webp" alt="tel aviv skatepark" />
            </picture>
            <div class="number">6 / 14</div>
        </div>
    
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/tel-aviv6.webp">
                <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/tel-aviv6.webp">
                <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/tel-aviv6.webp">                
                <img src="/images/ParkGallery-webp/tel-aviv6.webp" alt="tel aviv skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/tel-aviv7.webp">
                <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/tel-aviv7.webp">
                <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/tel-aviv7.webp">                
                <img src="/images/ParkGallery-webp/tel-aviv7.webp" alt="tel aviv skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/tel-aviv8.webp">
                <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/tel-aviv8.webp">
                <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/tel-aviv8.webp">
                <img src="/images/ParkGallery-webp/tel-aviv8.webp" alt="tel aviv skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/tel-aviv9.webp">
                <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/tel-aviv9.webp">
                <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/tel-aviv9.webp">                
                <img src="/images/ParkGallery-webp/tel-aviv9.webp" alt="tel aviv skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/tel-aviv10.webp">
                <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/tel-aviv10.webp">
                <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/tel-aviv10.webp">                
                <img src="/images/ParkGallery-webp/tel-aviv10.webp" alt="tel aviv skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/tel-aviv11.webp">
                <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/tel-aviv11.webp">
                <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/tel-aviv11.webp">                
                <img src="/images/ParkGallery-webp/tel-aviv11.webp" alt="tel aviv skatepark" />
            </picture>
            <div class="number">12 / 14</div>
        </div>

        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/tel-aviv12.webp">
                <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/tel-aviv12.webp">
                <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/tel-aviv12.webp">
                <img src="/images/ParkGallery-webp/tel-aviv12.webp" alt="tel aviv skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/tel-aviv13.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/tel-aviv13.webp">
                <!-- no 1500px image available -->
                <img src="/images/ParkGallery-webp/tel-aviv13.webp" alt="tel aviv skatepark" />
            </picture>
...
<div class="list-img">
  <ul> 
    ...
    <hr>
      ...
      <li>From sunset untill 01:00.</li>
      <hr>
      <li><strong>Address :</strong></li>
      <li>Ha-Shlosha St 2, Tel Aviv-Yafo.</li>
      <hr>
      <li>Open since 2007.</li>
    </ul>
...
<g>
  ...
  <br>
  <span><strong>Address :</strong><br>Ha-Shlosha St 2, Tel Aviv-Yafo.​</span>
</div>
<div class="social-maps"> 
  <div class="map-icon">
  <a href="https://waze.com/ul/hsv8wrss9x" target="_blank" class="waze" id="tel-aviv-waze">
     <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
     <g>
...
<div class="map-icon">
  <a href="https://maps.app.goo.gl/9264XPB9Q7fnUa8u8?g_st=iw" target="_blank" class="google" id="tel-aviv-google">
   <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
      viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
   <style type="text/css">
     .st22{fill:auto;}
...
<div class="map-icon">
 <a href="https://maps.apple.com/?address=Wingate%20Street%202,%20Tel%20Aviv-Yafo%206706901,%20Israel&auid=16772926490684523737&ll=32.061246,34.789225&lsp=9902&q=Galit%20Skatepark&t=h" target="_blank" class="apple" id="tel-aviv-apple">
     <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
     <style type="text/css">
       .st20{fill:auto;}
...
<div class="vid-map">
    <div class="iconBox2">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/tyXhVO8ygj4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    </div>
    <div class="google-map">
      <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d27050.736129003257!2d34.787485!3d32.059997!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x151d4b7031657091%3A0x7102fbc2a13109f9!2sGalit%20Skatepark%2C%20Tel%20Aviv-Yafo!5e0!3m2!1sen!2sus!4v1684620546010!5m2!1sen!2sus%22" width="560" height="315" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>  </div>
  </div>
