...
<head>
  ...
  <title>Modi'in - Moriah Park | ENBOSS</title>
  <meta name="description" content="Modi'in Moriah Extreme Sports Hub: Unleash Your Skills in an Expansive Playground. Explore the vast expanse of Modi'in Moriah Skatepark, a premier destination for extreme sports enthusiasts. From thrilling ramps to challenging obstacles, this hub offers endless opportunities to showcase your talent. Embrace the adrenaline rush, connect with like-minded athletes, and push the boundaries of what you thought was possible. Get ready to take your extreme sports and freestyle skills to new heights at Modi'in Moriah Skatepark.">  

  <meta property="og:type" content="website">
  <meta property="og:title" content="Modi'in - Moriah Skatepark">
  <meta property="og:image" content="http://www.enboss.co/images/ParkFav/modiinMoriah.png">
  <meta property="og:image:secure_url" content="https://www.enboss.co/images/ParkFav/modiinMoriah.png">
  <meta property="og:description" content="Unleash Your Skills in an Expansive Playground. Experience the Thrills of Extreme Sports and Freestyle Action.">
  <meta property="og:url" content="http://www.enboss.co/en/skateparks/modiin-moriah-park">
  ...
  <meta name="keywords" content="israel, skatepark, rollerblade, skate, hebrew, modiin, moriah, park, roller, israeli, scoot, jerusalem, tel aviv, middle east, enboss.co">
...
<div class="parkHead">
  <h1>Modi'in - Moriah Park</h1>
      <!-- slideshow html -->
      <div class="slideshowDiv" >
        <div class="carousel-container">
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/modiin-moriah.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/modiin-moriah.webp">
                <img src="/images/ParkGallery-webp/modiin-moriah.webp" alt="modiin moriah skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/modiin-moriah1.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/modiin-moriah1.webp">
                <img src="/images/ParkGallery-webp/modiin-moriah1.webp" alt="modiin moriah skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/modiin-moriah2.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/modiin-moriah2.webp">
                <img src="/images/ParkGallery-webp/modiin-moriah2.webp" alt="modiin moriah skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/modiin-moriah3.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/modiin-moriah3.webp">
                <img src="/images/ParkGallery-webp/modiin-moriah3.webp" alt="modiin moriah skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/modiin-moriah4.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/modiin-moriah4.webp">
                <img src="/images/ParkGallery-webp/modiin-moriah4.webp" alt="modiin moriah skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/modiin-moriah5.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/modiin-moriah5.webp">
                <img src="/images/ParkGallery-webp/modiin-moriah5.webp" alt="modiin moriah skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/modiin-moriah6.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/modiin-moriah6.webp">
                <img src="/images/ParkGallery-webp/modiin-moriah6.webp" alt="modiin moriah skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/modiin-moriah7.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/modiin-moriah7.webp">
                <img src="/images/ParkGallery-webp/modiin-moriah7.webp" alt="modiin moriah skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/modiin-moriah8.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/modiin-moriah8.webp">
                <img src="/images/ParkGallery-webp/modiin-moriah8.webp" alt="modiin moriah skatepark" />
            </picture>
...
<div class="list-img">
  <ul>
    ...
    <li>Moriya Park, Begin St corner of HaChashmonaim, Modi'in.​​</li>
    <hr>
    <li><strong>* </strong>In July and August, park lights are on until 00:00.​</li>
    <hr>
    <li>Open since 2012.</li>
  </ul>
...
<g>
  ...
  <br>
  <span><strong>Address :</strong><br>Moriya Park, Begin St corner of HaChashmonaim, Modi'in.​</span>
</div>
<div class="social-maps"> 
    <div class="map-icon">
    <a href="https://waze.com/ul/hsv8vk7tmx" target="_blank" class="waze" id="modiin-moriah-waze">
       <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
       <g>
  ...
  <div class="map-icon">
    <a href="https://maps.app.goo.gl/ZTF3CSQ4uXv1MdzP7?g_st=iw" target="_blank" class="google" id="modiin-moriah-google">
     <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
     <style type="text/css">
       .st22{fill:auto;}
  ...
  <div class="map-icon">
   <a href="https://maps.apple.com/?ll=31.880890,34.999021&q=Dropped%20Pin&t=h" target="_blank" class="apple" id="modiin-moriah-apple">
       <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
       <style type="text/css">
         .st20{fill:auto;}
...
<div class="vid-map">
  ...
  <div class="google-map">
    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3387.943350919008!2d34.999599!3d31.880957000000002!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1502ce7f21bb33df%3A0x800b021be96fc1b0!2sMoriah%20Skatepark!5e0!3m2!1sen!2sus!4v1684700394922!5m2!1sen!2sus" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>  </div>
</div>
</div>
