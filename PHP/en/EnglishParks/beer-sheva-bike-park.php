...
<head>
  ...
  <title>Be'er Sheva Bike Park | ENBOSS</title>
  <meta name="description" content="Unleash Your Skills at Be'er Sheva Bike Park: An Urban Haven for Extreme Sp">  

  <meta property="og:type" content="website">
  <meta property="og:title" content="Be'er Sheva Bike Park">
  <meta property="og:image" content="http://www.enboss.co/images/ParkFav/beer-sheva-bike.png">
  <meta property="og:image:secure_url" content="https://www.enboss.co/images/ParkFav/beer-sheva-bike.png">
  <meta property="og:description" content="An Urban Heaven for Extreme Sports Enthusiasts">  
  <meta property="og:url" content="http://www.enboss.co/en/skateparks/beer-sheva-bike-park">
  <meta property="og:site_name" content="ENBOSS">
  <link rel="icon" href="/svg/EnbossFavIcon.svg">
  <meta property="og:locale" content="en_US">
  <meta name="keywords" content="israel, skatepark, rollerblade, skate, hebrew, beer sheva, bike park, roller, israeli, scoot, jerusalem, tel aviv, middle east, enboss.co">
...
<main class="parkMain body-move">
  ...
  <div class="parkHead">
    <h1>Be'er Sheva - Bike Park</h1>
        <!-- slideshow html -->
        <div class="slideshowDiv" >
            <div class="carousel-container">
            <div class="mySlides">
                <picture>
                    <source media="(max-width: 768px)" srcset="/images/Park768-webp/beer-sheva-bike.webp">
                    <source media="(max-width: 1200px)" srcset="/images/ParkGallery-webp/beer-sheva-bike.webp">
                    <source media="(min-width: 1199px)" srcset="/images/Park1500-webp/beer-sheva-bike.webp">
                    <img src="/images/ParkGallery-webp/beer-sheva-bike.webp" alt="be'er sheva bike park" />
                </picture>
            ...
            <div class="mySlides">
                <picture>
                    <source media="(max-width: 768px)" srcset="/images/Park768-webp/beer-sheva-bike1.webp">
                    <source media="(max-width: 1200px)" srcset="/images/ParkGallery-webp/beer-sheva-bike1.webp">
                    <source media="(min-width: 1199px)" srcset="/images/Park1500-webp/beer-sheva-bike1.webp">
                    <img src="/images/ParkGallery-webp/beer-sheva-bike1.webp" alt="be'er sheva bike park" />
                </picture>
            ...
            <div class="mySlides">
                <picture>
                    <source media="(max-width: 768px)" srcset="/images/Park768-webp/beer-sheva-bike2.webp">
                    <source media="(max-width: 1200px)" srcset="/images/ParkGallery-webp/beer-sheva-bike2.webp">
                    <source media="(min-width: 1199px)" srcset="/images/Park1500-webp/beer-sheva-bike2.webp">
                    <img src="/images/ParkGallery-webp/beer-sheva-bike2.webp" alt="be'er sheva bike park" />
                </picture>
            ...
            <div class="mySlides">
                <picture>
                    <source media="(max-width: 768px)" srcset="/images/Park768-webp/beer-sheva-bike3.webp">
                    <source media="(max-width: 1200px)" srcset="/images/ParkGallery-webp/beer-sheva-bike3.webp">
                    <source media="(min-width: 1199px)" srcset="/images/Park1500-webp/beer-sheva-bike3.webp">
                    <img src="/images/ParkGallery-webp/beer-sheva-bike3.webp" alt="be'er sheva bike park" />
                </picture>
            ...
            <div class="mySlides">
                <picture>
                    <source media="(max-width: 768px)" srcset="/images/Park768-webp/beer-sheva-bike4.webp">
                    <source media="(max-width: 1200px)" srcset="/images/ParkGallery-webp/beer-sheva-bike4.webp">
                    <source media="(min-width: 1199px)" srcset="/images/Park1500-webp/beer-sheva-bike4.webp">
                    <img src="/images/ParkGallery-webp/beer-sheva-bike4.webp" alt="be'er sheva bike park" />
                </picture>
            ...
            <div class="mySlides">
                <picture>
                    <source media="(max-width: 768px)" srcset="/images/Park768-webp/beer-sheva-bike5.webp">
                    <source media="(max-width: 1200px)" srcset="/images/ParkGallery-webp/beer-sheva-bike5.webp">
                    <source media="(min-width: 1199px)" srcset="/images/Park1500-webp/beer-sheva-bike5.webp">
                    <img src="/images/ParkGallery-webp/beer-sheva-bike5.webp" alt="be'er sheva bike park" />
                </picture>
            ...
            <div class="mySlides">
                <picture>
                    <source media="(max-width: 768px)" srcset="/images/Park768-webp/beer-sheva-bike6.webp">
                    <source media="(max-width: 1200px)" srcset="/images/ParkGallery-webp/beer-sheva-bike6.webp">
                    <source media="(min-width: 1199px)" srcset="/images/Park1500-webp/beer-sheva-bike6.webp">
                    <img src="/images/ParkGallery-webp/beer-sheva-bike6.webp" alt="be'er sheva bike park" />
                </picture>
            ...
            <div class="mySlides">
                <picture>
                    <source media="(max-width: 768px)" srcset="/images/Park768-webp/beer-sheva-bike7.webp">
                    <source media="(max-width: 1200px)" srcset="/images/ParkGallery-webp/beer-sheva-bike7.webp">
                    <source media="(min-width: 1199px)" srcset="/images/Park1500-webp/beer-sheva-bike7.webp">
                    <img src="/images/ParkGallery-webp/beer-sheva-bike7.webp" alt="be'er sheva bike park" />
                </picture>
            ...
            <div class="mySlides">
                <picture>
                    <source media="(max-width: 768px)" srcset="/images/Park768-webp/beer-sheva-bike8.webp">
                    <source media="(max-width: 1200px)" srcset="/images/ParkGallery-webp/beer-sheva-bike8.webp">
                    <source media="(min-width: 1199px)" srcset="/images/Park1500-webp/beer-sheva-bike8.webp">
                    <img src="/images/ParkGallery-webp/beer-sheva-bike8.webp" alt="be'er sheva bike park" />
                </picture>
            ...
            <div class="mySlides">
                <picture>
                    <source media="(max-width: 768px)" srcset="/images/Park768-webp/beer-sheva-bike9.webp">
                    <source media="(max-width: 1200px)" srcset="/images/ParkGallery-webp/beer-sheva-bike9.webp">
                    <source media="(min-width: 1199px)" srcset="/images/Park1500-webp/beer-sheva-bike9.webp">
                    <img src="/images/ParkGallery-webp/beer-sheva-bike9.webp" alt="be'er sheva bike park" />
                </picture>
  ...
  <div class="list-img">
    <ul>
        ...
        <li><strong>Sat :</strong> 09:00-22:00</li>
        <li><strong>Fri and Holidays :</strong> 12:00-16:00</li>
        <hr>
        <li><strong>Address :</strong></li>
        <li>Derech Ilan Ramon 22, Be'er Sheva.</li>
        <hr>
        <li><strong>* </strong>During the summer the park will be open for an extra one hour.</li>
        <hr>
  ...
  <g>
    ...
    <br>
    <span><strong>Address :</strong><br>Derech Ilan Ramon 22, Be'er Sheva.​</span>
  </div>
  <div class="social-maps"> 
    <div class="map-icon">
      <a href="https://waze.com/ul/hsv89ycype" target="_blank" class="waze" id="beer-sheva-waze">
       <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
       <g>
  ...
  <div class="map-icon">
    <a href="https://goo.gl/maps/VPLjAQzcvMqGEUFD9" target="_blank" class="google" id="beer-sheva-google">
     <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
     <style type="text/css">
       .st22{fill:auto;}
  ...
  <div class="map-icon">
    <a href="https://maps.apple.com/?ll=31.255974,34.758632&q=Dropped%20Pin&t=h" target="_blank" class="apple" id="beer-sheva-apple">
       <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
       <style type="text/css">
         .st20{fill:auto;}
  ...
  <div class="vid-map">
    ...
    <div class="google-map">
      <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d27285.829856032226!2d34.758597!3d31.255932000000005!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x150265e9941c5e8d%3A0x45f29cc67a9752ca!2sSkate%20Park!5e0!3m2!1sen!2sus!4v1684691540554!5m2!1sen!2sus" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
  </div>
