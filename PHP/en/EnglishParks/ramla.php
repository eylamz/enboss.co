...
<head>
  ...
  <title>Ramla | ENBOSS</title>
  <meta name="description" content="Thrilling Rides Await at Ramla Skatepark. Experience the adrenaline rush at Ramla's dynamic skatepark. With ramps, rails, and obstacles, this urban playground is a haven for extreme sports enthusiasts. Skateboarders, rollerbladers, and scooter riders can unleash their skills and push their limits in this action-packed destination. Get ready to carve, grind, and soar through the air at Ramla Skatepark.">  

  <meta property="og:type" content="website">
  <meta property="og:title" content="Ramla Skatepark">
  <meta property="og:image" content="http://www.enboss.co/images/ParkFav/ramla.png">
  <meta property="og:image:secure_url" content="https://www.enboss.co/images/ParkFav/ramla.png">
...
<main class="parkMain body-move">
  ...
  <div class="parkHead">
    <h1>Ramla</h1>
        ...
        <div class="slideshowDiv" >
            ...
            <div class="mySlides">
                <picture>
                    <source media="(max-width: 768px)" srcset="/images/Park768-webp/ramla.webp">
                    <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/ramla.webp">
                    <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/ramla.webp">
                    <img src="/images/ParkGallery-webp/ramla.webp" alt="ramla skatepark" />
                </picture>
            ...
            <div class="mySlides">
              <picture>
                  <source media="(max-width: 768px)" srcset="/images/Park768-webp/ramla1.webp">
                  <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/ramla1.webp">
                  <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/ramla1.webp">
                  <img src="/images/ParkGallery-webp/ramla1.webp" alt="ramla skatepark" />
              </picture>
            ...
            <div class="mySlides">
              <picture>
                  <source media="(max-width: 768px)" srcset="/images/Park768-webp/ramla2.webp">
                  <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/ramla2.webp">
                  <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/ramla2.webp">
                  <img src="/images/ParkGallery-webp/ramla2.webp" alt="ramla skatepark" />
              </picture>
            ...
            <div class="mySlides">
              <picture>
                  <source media="(max-width: 768px)" srcset="/images/Park768-webp/ramla3.webp">
                  <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/ramla3.webp">
                  <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/ramla3.webp">
                  <img src="/images/ParkGallery-webp/ramla3.webp" alt="ramla skatepark" />
              </picture>
            ...
            <div class="mySlides">
              <picture>
                  <source media="(max-width: 768px)" srcset="/images/Park768-webp/ramla4.webp">
                  <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/ramla4.webp">
                  <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/ramla4.webp">
                  <img src="/images/ParkGallery-webp/ramla4.webp" alt="ramla skatepark" />
              </picture>
            ...
            <div class="mySlides">
              <picture>
                  <source media="(max-width: 768px)" srcset="/images/Park768-webp/ramla5.webp">
                  <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/ramla5.webp">
                  <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/ramla5.webp">
                  <img src="/images/ParkGallery-webp/ramla.webp" alt="ramla skatepark" />
              </picture>
            ...
            <div class="mySlides">
              <picture>
                  <source media="(max-width: 768px)" srcset="/images/Park768-webp/ramla6.webp">
                  <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/ramla6.webp">
                  <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/ramla6.webp">
                  <img src="/images/ParkGallery-webp/ramla6.webp" alt="ramla skatepark" />
              </picture>
  ...
  <div class="list-img">
    <ul>
        ...
        <li>Behind Yair Sthern St 33, Ramla.</li>
        <hr>
  ...
  <g>
    ...
    <br>
    <span><strong>Address :</strong><br>Behind Yair Sthern St 33, Ramla.​</span>
  </div>
  <div class="social-maps"> 
    <div class="map-icon">
      <a href="https://waze.com/ul/hsv8v9tv86" target="_blank" class="waze" id="ramla-waze">
       <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
       <g>
  ...
  <div class="map-icon">
    <a href="https://maps.app.goo.gl/KLJDmsE3rzpBVxs39?g_st=iw" target="_blank" class="google" id="ramla-google">
     <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
     <style type="text/css">
       .st22{fill:auto;}
  ...
  <div class="map-icon">
    <a href="https://maps.apple.com/?auid=13027913968805648369&ll=31.935908,34.878485&lsp=7618&q=Dropped%20Pin&t=h" target="_blank" class="apple" id="ramla-apple">
       <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
       <style type="text/css">
         .st20{fill:auto;}
