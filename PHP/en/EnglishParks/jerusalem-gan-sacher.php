...
<head>
  ...
  <title>Jerusalem Gan Sacher | ENBOSS</title>
  <meta name="description" content="Experience Adrenaline at Jerusalem's Gan Sacher Skatepark. Push the boundaries of extreme sports in this urban oasis. Whether you're into skateboarding, BMX, or rollerblading, this vibrant park offers endless excitement and challenges for all thrill-seekers. Get ready to elevate your skills and embrace the rush of the city's premier skatepark.">  

  <meta property="og:type" content="website">
  <meta property="og:title" content="Jerusalem Gan Sacher Skatepark">
  <meta property="og:image" content="http://www.enboss.co/images/ParkFav/jeruGanSacher.png">
  <meta property="og:image:secure_url" content="https://www.enboss.co/images/ParkFav/jeruGanSacher.png">
  <meta property="og:description" content="Elevate Your Skills. Embrace Urban Thrills. Unleash the Adrenaline.">
  <meta property="og:url" content="http://www.enboss.co/en/skateparks/jerusalem-gan-sacher">
  <meta property="og:site_name" content="ENBOSS">
  <link rel="icon" href="/svg/EnbossFavIcon.svg">
  <meta property="og:locale" content="en_US">
  <meta name="keywords" content="israel, skatepark, rollerblade, skate, hebrew, jerusalem, gan sacher, roller, israeli, scoot, jerusalem, tel aviv, middle east, enboss.co">
...
<div class="parkHead">
  <h1>Jerusalem - Gan Sacher</h1>
      <!-- slideshow html -->
      <div class="slideshowDiv" >
        <div class="carousel-container">
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/jeruGanSacher.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/jeruGanSacher.webp">
                <img src="/images/ParkGallery-webp/jeruGanSacher.webp" alt="Jerusalem Gan Sacher Skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/jeruGanSacher1.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/jeruGanSacher1.webp">
                <img src="/images/ParkGallery-webp/jeruGanSacher1.webp" alt="Jerusalem Gan Sacher Skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/jeruGanSacher2.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/jeruGanSacher2.webp">
                <img src="/images/ParkGallery-webp/jeruGanSacher2.webp" alt="Jerusalem Gan Sacher Skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/jeruGanSacher3.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/jeruGanSacher3.webp">
                <img src="/images/ParkGallery-webp/jeruGanSacher3.webp" alt="Jerusalem Gan Sacher Skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/jeruGanSacher4.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/jeruGanSacher4.webp">
                <img src="/images/ParkGallery-webp/jeruGanSacher4.webp" alt="Jerusalem Gan Sacher Skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/jeruGanSacher5.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/jeruGanSacher5.webp">
                <img src="/images/ParkGallery-webp/jeruGanSacher5.webp" alt="Jerusalem Gan Sacher Skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/jeruGanSacher6.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/jeruGanSacher6.webp">
                <img src="/images/ParkGallery-webp/jeruGanSacher6.webp" alt="Jerusalem Gan Sacher Skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/jeruGanSacher7.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/jeruGanSacher7.webp">
                <img src="/images/ParkGallery-webp/jeruGanSacher7.webp" alt="Jerusalem Gan Sacher Skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/jeruGanSacher8.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/jeruGanSacher8.webp">
                <img src="/images/ParkGallery-webp/jeruGanSacher8.webp" alt="Jerusalem Gan Sacher Skatepark" />
            </picture>
...
<div class="list-img">
  <ul> 
      ...
      <li>Everyday : 08:00 - 23:00</li>
      <hr>
      <li><strong>Address :</strong></li>
      <li>Gan Sacher Park, Sderot Yitshak Rabin, Jerusalem.</li>
      <hr>
...
<g>
  ...
  <br>
  <span><strong>Address :</strong><br>Gan Sacher Park, Sderot Yitshak Rabin, Jerusalem.​</span>
</div>
