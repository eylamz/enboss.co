...
<head>
  ...
  <title>Modi'in - Buchman Park | ENBOSS</title>
  <meta name="description" content="Experience Thrills in a Compact Setting. Discover the excitement of Modi'in Buchman Skatepark, a compact yet exhilarating skatepark designed for extreme sports enthusiasts. Master your tricks, navigate the ramps and rails, and soak in the vibrant atmosphere of this hidden gem. Join fellow skaters and riders for a thrilling session of adrenaline-fueled fun.">  

  <meta property="og:type" content="website">
  <meta property="og:title" content="Modi'in Buchman Skatepark">
  <meta property="og:image" content="http://www.enboss.co/images/ParkFav/modiinBuchman.png">
  <meta property="og:image:secure_url" content="https://www.enboss.co/images/ParkFav/modiinBuchman.png">
...
<main class="parkMain body-move">
  ...
  <div class="parkHead">
    <h1>Modi'in - Buchman Park</h1>
        <!-- slideshow html -->
        <div class="slideshowDiv" >
          <div class="carousel-container">
          <div class="mySlides">
              <picture>
                  <source media="(max-width: 768px)" srcset="/images/Park768-webp/modiinBuchman.webp">
                  <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/modiinBuchman.webp">
                  <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/modiinBuchman.webp">
                  <img src="/images/ParkGallery-webp/modiinBuchman.webp" alt="modiin buchman skatepark" />
              </picture>
          ...
          <div class="mySlides">
            <picture>
              <source media="(max-width: 768px)" srcset="/images/Park768-webp/modiinBuchman1.webp">
              <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/modiinBuchman1.webp">
              <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/modiinBuchman1.webp">
              <img src="/images/ParkGallery-webp/modiinBuchman1.webp" alt="modiin buchman skatepark" />
          </picture>
          ...
          <div class="mySlides">
            <picture>
              <source media="(max-width: 768px)" srcset="/images/Park768-webp/modiinBuchman2.webp">
              <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/modiinBuchman2.webp">
              <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/modiinBuchman2.webp">
              <img src="/images/ParkGallery-webp/modiinBuchman2.webp" alt="modiin buchman skatepark" />
          </picture>
          ...
          <div class="mySlides">
            <picture>
              <source media="(max-width: 768px)" srcset="/images/Park768-webp/modiinBuchman3.webp">
              <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/modiinBuchman3.webp">
              <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/modiinBuchman3.webp">
              <img src="/images/ParkGallery-webp/modiinBuchman3.webp" alt="modiin buchman skatepark" />
          </picture>
  ...
  <div class="list-img">
    <ul>
        ...
        <li>Sara Imenu St corner of Rivka Imenu St, Modi'in.</li>
        <hr>
        <li><strong>* </strong>In July and August, park lights are on until 00:00.​</li>
        <hr>
        <li>Open since 2009.</li>
      </ul>
  ...
  <g>
    ...
    <br>
    <span><strong>Address :</strong><br>Sara Imenu St corner of Rivka Imenu St, Modi'in.</span>
  </div>
  <div class="social-maps"> 
    <div class="map-icon">
      <a href="https://waze.com/ul/hsv8vkefvn" target="_blank" class="waze" id="modiinBuchman-waze">
       <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
       <g>
  ...
  <div class="map-icon">
    <a href="https://maps.app.goo.gl/LpbuEJepXLtCNqCH7?g_st=iw" target="_blank" class="google" id="modiinBuchman-google">
     <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
     <style type="text/css">
       .st22{fill:auto;}
  ...
  <div class="map-icon">
    <a href="https://maps.apple.com/?ll=31.881772,35.006596&q=Dropped%20Pin&t=h" target="_blank" class="apple" id="modiinBuchman-apple">
       <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
       <style type="text/css">
         .st20{fill:auto;}
  ...
  <div class="vid-map">
    ...
    <div class="google-map">
      <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d13551.652327788583!2d35.00654!3d31.88178!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1502cdf6add2d2b7%3A0xeb0b3a3de5700641!2sBuchman%20skatepark!5e0!3m2!1sen!2sus!4v1684793640995!5m2!1sen!2sus" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
  </div>
