...
<head>
  ...
  <title>Ramat Gan - Kiryat Krinitsi | ENBOSS</title>
  <meta name="description" content="Unleash Your Skills in Ramat Gan Skatepark. Discover the heart-pumping excitement of Ramat Gan's vibrant skatepark. Challenge yourself on the ramps, grind the rails, and conquer the obstacles that await. Whether you're a skateboarder, rollerblader, or scooter rider, this urban playground offers endless thrills for extreme sports enthusiasts. Strap on your gear and prepare for an adrenaline-fueled adventure in Ramat Gan's skatepark.">

  <meta property="og:type" content="website">
  <meta property="og:title" content="Ramat Gan - Kiryat Krinitsi Skatepark">
  <meta property="og:image" content="http://www.enboss.co/images/ParkFav/ramat-gan.png">
  <meta property="og:image:secure_url" content="https://www.enboss.co/images/ParkFav/ramat-gan.png">
  <meta property="og:description" content="Embrace the Thrills of an Urban Playground in Ramat Gan">  
  <meta property="og:url" content="http://www.enboss.co/en/skateparks/ramat-gan">
  ...
  <meta name="keywords" content="israel, skatepark, rollerblade, skate, hebrew, ramat gan, roller, israeli, scoot, jerusalem, tel aviv, middle east, enboss.co">
...
<body class="parkBody">
  ...
  <h1 class="deskH1">Ramat Gan - Kiryat Krinitsi</h1>
  <h1 id="mobileH1">Ramat Gan<br><strong>Kiryat Krinitsi</strong></h1>    
    <!-- slideshow html -->
      <div class="slideshowDiv" >
        <div class="carousel-container">
          <div class="mySlides">
              <picture>
                  <source media="(max-width: 768px)" srcset="/images/Park768-webp/ramat-gan.webp">
                  <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/ramat-gan.webp">
                  <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/ramat-gan.webp">
                  <img src="/images/ParkGallery-webp/ramat-gan.webp" alt="ramat gan skatepark" />
              </picture>
          ...
          <div class="mySlides">
              <picture>
                  <source media="(max-width: 768px)" srcset="/images/Park768-webp/ramat-gan1.webp">
                  <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/ramat-gan1.webp">
                  <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/ramat-gan1.webp">
                  <img src="/images/ParkGallery-webp/ramat-gan1.webp" alt="ramat gan skatepark" />
              </picture>
          ...
          <div class="mySlides">
              <picture>
                  <source media="(max-width: 768px)" srcset="/images/Park768-webp/ramat-gan2.webp">
                  <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/ramat-gan2.webp">
                  <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/ramat-gan2.webp">
                  <img src="/images/ParkGallery-webp/ramat-gan2.webp" alt="ramat gan skatepark" />
              </picture>
          ...
          <div class="mySlides">
              <picture>
                  <source media="(max-width: 768px)" srcset="/images/Park768-webp/ramat-gan3.webp">
                  <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/ramat-gan3.webp">
                  <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/ramat-gan3.webp">
                  <img src="/images/ParkGallery-webp/ramat-gan3.webp" alt="ramat gan skatepark" />
              </picture>
          ...
          <div class="mySlides">
              <picture>
                  <source media="(max-width: 768px)" srcset="/images/Park768-webp/ramat-gan4.webp">
                  <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/ramat-gan4.webp">
                  <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/ramat-gan4.webp">
                  <img src="/images/ParkGallery-webp/ramat-gan4.webp" alt="ramat gan skatepark" />
              </picture>
...
<div class="list-img">
  <ul>
    ...
    <li id="closed">- Permanently closed -</li> -->
    <li><strong>Opening Hours :</strong> 24/7</li>
    <hr>
    <li><strong>Every day :</strong> 08:00-23:00</li>
    <hr>
    <li><strong>Address :</strong></li>
      <li>Haim Barlev St 7, Ramat Gan.​</li>
    <hr>
    <li>Opened in 2021.</li>
    </ul>
...
<g>
  ...
  <br>
  <span><strong>Address :</strong><br>Haim Barlev St 7, Ramat Gan.​</span>
</div>
<div class="social-maps"> 
    <div class="map-icon">
    <a href="https://waze.com/ul/hsv8y2gth4" target="_blank" class="waze" id="ramat-gan-waze">
       <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
       <g>
  ...
  <div class="map-icon">
    <a href="https://maps.app.goo.gl/KXZkV7k8Ma3YrgaF8?g_st=ic" target="_blank" class="google" id="ramat-gan-google">
     <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
     <style type="text/css">
       .st22{fill:auto;}
  ...
  <div class="map-icon">
   <a href="https://maps.apple.com/?auid=16626089113384445991&ll=32.055600,34.844532&lsp=7618&q=Dropped%20Pin&_ext=EiYpgWvdvCcFQEAxJrCUwEFmQUA5WkUkr3MNQEBBWOTXD7FsQUBQDA%3D%3D&t=h" target="_blank" class="apple" id="ramat-gan-apple">
       <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
       <style type="text/css">
         .st20{fill:auto;}
...
<div class="vid-map">
  ...
  <div class="google-map">
    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3381.5685429638606!2d34.835969!3d32.053868!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x151d4b010bc7dcd3%3A0xece07580b202c75e!2z16HXp9eZ15nXmNek15DXqNenINeo157XqiDXktefINen16jXmdeqINen16jXmdeg15nXpteZ!5e0!3m2!1sen!2sus!4v1684822910174!5m2!1sen!2sus" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>  </div>
</div>
</div>
