...
<head>
  ...
  <title>Ra'anana | ENBOSS</title>
  <meta name="description" content="Unleash Your Passion for Extreme Sports at Ra'anana Skatepark. Grab your skateboard, scooter, or BMX bike and get ready for an adrenaline-fueled experience. This state-of-the-art skatepark in Raanana offers ramps, rails, and endless possibilities for tricks and stunts. Join fellow enthusiasts and take your skills to new heights in this thrilling urban playground.">  

  <meta property="og:type" content="website">
  <meta property="og:title" content="Ra'anana Skatepark">
  <meta property="og:image" content="http://www.enboss.co/images/ParkFav/raanana.png">
  <meta property="og:image:secure_url" content="https://www.enboss.co/images/ParkFav/raanana.png">
  <meta property="og:description" content="Embrace the Thrill of Extreme Sports in an Urban Playground">  
  <meta property="og:url" content="http://www.enboss.co/en/skateparks/raanana">
  <meta property="og:site_name" content="ENBOSS">
  <link rel="icon" href="/svg/EnbossFavIcon.svg">
  <meta property="og:locale" content="en_US">
  <meta name="keywords" content="israel, skatepark, rollerblade, skate, hebrew, raanana, roller, israeli, scoot, jerusalem, tel aviv, middle east, enboss.co">
...
<body class="parkBody">
  ...
  <h1>Ra'anana</h1>
      ...
      <div class="slideshowDiv" >
        ...
        <div class="mySlides">
          <picture>
            <source media="(max-width: 768px)" srcset="/images/Park768-webp/raanana1.webp">
            <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/raanana1.webp">
            <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/raanana1.webp">
            <img src="/images/ParkGallery-webp/raanana1.webp" alt="raanana skatepark" />
        </picture>
        ...
        <div class="mySlides">
          <picture>
            <source media="(max-width: 768px)" srcset="/images/Park768-webp/raanana2.webp">
            <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/raanana2.webp">
            <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/raanana2.webp">
            <img src="/images/ParkGallery-webp/raanana2.webp" alt="raanana skatepark" />
        </picture>
        ...
        <div class="mySlides">
          <picture>
            <source media="(max-width: 768px)" srcset="/images/Park768-webp/raanana3.webp">
            <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/raanana3.webp">
            <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/raanana3.webp">
            <img src="/images/ParkGallery-webp/raanana3.webp" alt="raanana skatepark" />
        </picture>
        ...
        <div class="mySlides">
          <picture>
            <source media="(max-width: 768px)" srcset="/images/Park768-webp/raanana4.webp">
            <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/raanana4.webp">
            <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/raanana4.webp">
            <img src="/images/ParkGallery-webp/raanana4.webp" alt="raanana skatepark" />
        </picture>
        ...
        <div class="mySlides">
          <picture>
            <source media="(max-width: 768px)" srcset="/images/Park768-webp/raanana5.webp">
            <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/raanana5.webp">
            <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/raanana5.webp">
            <img src="/images/ParkGallery-webp/raanana5.webp" alt="raanana skatepark" />
        </picture>
        ...
        <div class="mySlides">
          <picture>
            <source media="(max-width: 768px)" srcset="/images/Park768-webp/raanana6.webp">
            <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/raanana6.webp">
            <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/raanana6.webp">
            <img src="/images/ParkGallery-webp/raanana6.webp" alt="raanana skatepark" />
        </picture>
        ...
        <div class="mySlides">
          <picture>
            <source media="(max-width: 768px)" srcset="/images/Park768-webp/raanana7.webp">
            <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/raanana7.webp">
            <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/raanana7.webp">
            <img src="/images/ParkGallery-webp/raanana7.webp" alt="raanana skatepark" />
        </picture>
...
<div class="list-img">
  <ul>
      ...
      <li><strong>Sun-Thu :</strong> 08:00-22:00</li>
      <li><strong>Fri :</strong> 08:00-19:00</li>
      <li><strong>Sat and Holidays :</strong> 08:00-22:00</li>
      <hr>
      <li><strong>Address :</strong></li>
      <li>Sasha Argov Street 34, Ra'anana.</li>
      <hr>
      <li><strong>* </strong>Bike riders are not allowed to enter.</li>
      <li><strong>* </strong>On Mondays and Thursdays, the park is open until 23:00.</li>
      <li><strong>* </strong>There is covering for sun protection in the park.​​</li>
      <li><strong>* </strong>From 20:00, no entry is allowed for children under 14 years old.​​</li>
      <hr>
...
<g>
  ...
  <br>
  <span><strong>Address :</strong><br>Sasha Argov Street 34, Ra'anana.​</span>
</div>
<div class="social-maps"> 
  <div class="map-icon">
  <a href="https://waze.com/ul/hsv8z1k9ds" target="_blank" class="waze" id="raanana-waze">
     <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
     <g>
...
<div class="map-icon">
  <a href="https://maps.app.goo.gl/NiwWMCxvi5xNfG8V7?g_st=iw" target="_blank" class="google" id="raanana-google">
   <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
      viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
   <style type="text/css">
     .st22{fill:auto;}
...
<div class="map-icon">
 <a href="https://maps.apple.com/?ll=32.193252,34.861252&q=Dropped%20Pin&t=m" target="_blank" class="apple" id="raanana-apple">
     <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
     <style type="text/css">
       .st20{fill:auto;}
...
<div class="vid-map">
  <div class="iconBox2">
    <iframe width="560" height="315" src="https://www.youtube.com/embed/Ya1UYf2tgek" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
  </div>
  <div class="google-map">
    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d27011.3696820971!2d34.861791!3d32.192879!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x151d478832845c4b%3A0xd29a0da0f3e5597d!2sRa%E2%80%99anana%20Skate%20Park!5e0!3m2!1sen!2sus!4v1683528557638!5m2!1sen!2sus" width="560" height="315" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
  </div>
</div>
