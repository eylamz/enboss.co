...
<head>
  ...
  <title>Jerusalem Gan Hapa'amon | ENBOSS</title>
  <meta name="description" content="Unleash Your Passion for Extreme Sports at Jerusalem's Gan Hapa'amon Skatepark. Experience the thrill of this vibrant urban playground as you push your limits and showcase your skills in various extreme sports. From heart-pounding jumps to jaw-dropping stunts, immerse yourself in the heart of the city's adrenaline-fueled culture.">  

  <meta property="og:type" content="website">
  <meta property="og:title" content="Jerusalem Gan Hapa'amon Skatepark">
  <meta property="og:image" content="http://www.enboss.co/images/ParkFav/jeruGanHapaamon.png">
  <meta property="og:image:secure_url" content="https://www.enboss.co/images/ParkFav/jeruGanHapaamon.png">
  <meta property="og:description" content="Ignite Your Adrenaline. Push Your Limits. Showcase Your Skills.">  
  <meta property="og:url" content="http://www.enboss.co/en/skateparks/jerusalem-gan-hapaamon">
  ...
  <meta name="keywords" content="israel, skatepark, rollerblade, skate, hebrew, gan hapaamon, roller, israeli, scoot, jerusalem, tel aviv, middle east, enboss.co">
...
<main class="parkMain body-move">
  ...
  <div class="parkHead">
    <h1>Jerusalem - Gan Hapa'amon</h1>
        <!-- slideshow html -->
        <div class="slideshowDiv" >
          <div class="carousel-container">
          <div class="mySlides">
              <picture>
                  <source media="(max-width: 768px)" srcset="/images/Park768-webp/jeruGanHapaamon.webp">
                  <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/jeruGanHapaamon.webp">
                  <source media="(min-width: 1200px)" srcset="/images/ParkGallery-webp/jeruGanHapaamon.webp">
                  <img src="/images/ParkGallery-webp/jeruGanHapaamon.webp" alt="jerusalem gan hapaamon skatepark" />
              </picture>
          ...
          <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/jeruGanHapaamon1.webp">
                <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/jeruGanHapaamon1.webp">
                <source media="(min-width: 1200px)" srcset="/images/ParkGallery-webp/jeruGanHapaamon1.webp">
                <img src="/images/ParkGallery-webp/jeruGanHapaamon1.webp" alt="jerusalem gan hapaamon skatepark" />
            </picture>
          ...
          <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/jeruGanHapaamon2.webp">
                <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/jeruGanHapaamon2.webp">
                <source media="(min-width: 1200px)" srcset="/images/ParkGallery-webp/jeruGanHapaamon2.webp">
                <img src="/images/ParkGallery-webp/jeruGanHapaamon2.webp" alt="jerusalem gan hapaamon skatepark" />
            </picture>
          ...
          <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/jeruGanHapaamon3.webp">
                <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/jeruGanHapaamon3.webp">
                <source media="(min-width: 1200px)" srcset="/images/ParkGallery-webp/jeruGanHapaamon3.webp">
                <img src="/images/ParkGallery-webp/jeruGanHapaamon3.webp" alt="jerusalem gan hapaamon skatepark" />
            </picture>
          ...
          <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/jeruGanHapaamon4.webp">
                <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/jeruGanHapaamon4.webp">
                <source media="(min-width: 1200px)" srcset="/images/ParkGallery-webp/jeruGanHapaamon4.webp">
                <img src="/images/ParkGallery-webp/jeruGanHapaamon4.webp" alt="jerusalem gan hapaamon skatepark" />
            </picture>
          ...
          <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/jeruGanHapaamon5.webp">
                <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/jeruGanHapaamon5.webp">
                <source media="(min-width: 1200px)" srcset="/images/ParkGallery-webp/jeruGanHapaamon5.webp">
                <img src="/images/ParkGallery-webp/jeruGanHapaamon5.webp" alt="jerusalem gan hapaamon skatepark" />
            </picture>
          ...
          <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/jeruGanHapaamon6.webp">
                <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/jeruGanHapaamon6.webp">
                <source media="(min-width: 1200px)" srcset="/images/ParkGallery-webp/jeruGanHapaamon6.webp">
                <img src="/images/ParkGallery-webp/jeruGanHapaamon6.webp" alt="jerusalem gan hapaamon skatepark" />
            </picture>
        ...
        <div class="mySlides">
        <picture>
            <source media="(max-width: 768px)" srcset="/images/Park768-webp/jeruGanHapaamon7.webp">
            <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/jeruGanHapaamon7.webp">
            <source media="(min-width: 1200px)" srcset="/images/ParkGallery-webp/jeruGanHapaamon7.webp">
            <img src="/images/ParkGallery-webp/jeruGanHapaamon7.webp" alt="jerusalem gan hapaamon skatepark" />
        </picture>
    ...
    <div class="mySlides">
    <picture>
        <source media="(max-width: 768px)" srcset="/images/Park768-webp/jeruGanHapaamon8.webp">
        <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/jeruGanHapaamon8.webp">
        <source media="(min-width: 1200px)" srcset="/images/ParkGallery-webp/jeruGanHapaamon8.webp">
        <img src="/images/ParkGallery-webp/jeruGanHapaamon8.webp" alt="jerusalem gan hapaamon skatepark" />
    </picture>
    ...
    <div class="mySlides">
    <picture>
        <source media="(max-width: 768px)" srcset="/images/Park768-webp/jeruGanHapaamon9.webp">
        <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/jeruGanHapaamon9.webp">
        <source media="(min-width: 1200px)" srcset="/images/ParkGallery-webp/jeruGanHapaamon9.webp">
        <img src="/images/ParkGallery-webp/jeruGanHapaamon9.webp" alt="jerusalem gan hapaamon skatepark" />
    </picture>
  ...
  <div class="list-img">
    <ul>
        ...
        <li><strong>Sun-Wed :</strong> 09:30-23:00</li>
        <li><strong>Thu :</strong> 09:30-23:30</li>
        <li><strong>Fri :</strong> 09:30-17:00</li>
        <li><strong>Sat and Holidays :</strong> 09:00-23:00</li>
        <hr>
        <li><strong>Address :</strong></li>
        <li>Liberty Bell Park, Corner of King David St and Jabotinsky St, Jerusalem.</li>
        <hr>
        <li>Open since 2014.</li>
      </ul>
  ...
  <g>
    ...
    <br>
    <span><strong>Address :</strong><br>Liberty Bell Park, Corner of King David St and Jabotinsky St, Jerusalem.​</span>
  </div>
  <div class="social-maps"> 
    <div class="map-icon">
      <a href="https://waze.com/ul/hsv9h9x2vm" target="_blank" class="waze" id="jeruGanHapaamon-waze">
       <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
       <g>
  ...
  <div class="map-icon">
    <a href="https://goo.gl/maps/wtPsY97DW7M6AcF48" target="_blank" class="google" id="jeruGanHapaamon-google">
     <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
     <style type="text/css">
       .st22{fill:auto;}
  ...
  <div class="map-icon">
    <a href="https://maps.apple.com/?ll=31.768774,35.222521&q=Dropped%20Pin&t=h" target="_blank" class="apple" id="jeruGanHapaamon-apple">
       <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
       <style type="text/css">
         .st20{fill:auto;}
  ...
  <div class="vid-map">
    ...
    <div class="google-map">
      <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d27136.574567962656!2d35.222584!3d31.768527!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1503282c55eb7ffb%3A0xbf7b617433fa9728!2sJerusalem%20Skate%20Park!5e0!3m2!1sen!2sus!4v1684774174257!5m2!1sen!2sus" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
  </div>
