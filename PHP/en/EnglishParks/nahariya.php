...
<head>
  ...
  <title>Nahariya | ENBOSS</title>
  <meta name="description" content="Discover Nahariya Skatepark: Thrilling Skateboarding and More. Nahariya Skatepark is an exciting destination for skateboarders, inline skaters, and scooter riders. Located by the coast, this park offers a thrilling experience with its impressive features. Join fellow extreme sports enthusiasts and enjoy the adrenaline rush at Nahariya Skatepark today!">  

  <meta property="og:type" content="website">
  <meta property="og:title" content="Nahariya Skatepark">
  <meta property="og:image" content="http://www.enboss.co/images/ParkFav/nahariya.png">
  <meta property="og:image:secure_url" content="https://www.enboss.co/images/ParkFav/nahariya.png">
  <meta property="og:description" content="Experience the Thrills of Extreme Sports at a Coastal Skatepark.">  
  <meta property="og:url" content="http://www.enboss.co/en/skateparks/nahariya">
  <meta property="og:site_name" content="ENBOSS">
  <link rel="icon" href="/svg/EnbossFavIcon.svg">
  <meta property="og:locale" content="en_US">
  <meta name="keywords" content="israel, skatepark, rollerblade, skate, hebrew, nahariya, roller, israeli, scoot, jerusalem, tel aviv, middle east, enboss.co">
...
<div class="parkHead">
  <h1>Nahariya</h1>
      ...
      <div class="slideshowDiv" >
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/nahariya1.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/nahariya1.webp">
                <img src="/images/ParkGallery-webp/nahariya1.webp" alt="nahariya skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/nahariya2.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/nahariya2.webp">
                <img src="/images/ParkGallery-webp/nahariya2.webp" alt="nahariya skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/nahariya3.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/nahariya3.webp">
                <img src="/images/ParkGallery-webp/nahariya3.webp" alt="nahariya skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/nahariya4.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/nahariya4.webp">
                <img src="/images/ParkGallery-webp/nahariya4.webp" alt="nahariya skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/nahariya5.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/nahariya5.webp">
                <img src="/images/ParkGallery-webp/nahariya5.webp" alt="nahariya skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/nahariya6.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/nahariya6.webp">
                <img src="/images/ParkGallery-webp/nahariya6.webp" alt="nahariya skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/nahariya7.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/nahariya7.webp">
                <img src="/images/ParkGallery-webp/nahariya7.webp" alt="nahariya skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/nahariya8.webp">
                <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/nahariya8.webp">
                <img src="/images/ParkGallery-webp/nahariya8.webp" alt="nahariya skatepark" />
            </picture>
...
<div class="list-img">
  <ul>
      ...
      <li><strong>Sun-Thu :</strong> 14:00-23:00</li>
      <li><strong>Fri :</strong> 12:00-20:00</li>
      <li><strong>Sat and Holidays :</strong> 09:00-23:00</li>
      <hr>
      <li><strong>Address :</strong></li>
      <li>Shvil David Dadon 15, Nahariya.</li>
      <hr>
      <li><strong>* </strong>Riders are required to wear a helmet.</li>
      <li><strong>* </strong>Bike riders are not allowed to enter.</li>
      <hr>
      <li>Open since 2021.</li>
    </ul>
...
<g>
  ...
  <br>
  <span><strong>Address :</strong><br>Shvil David Dadon 15, Nahariya.​</span>
</div>
<div class="social-maps"> 
  <div class="map-icon">
  <a href="https://waze.com/ul/hsvbgy2x1u" target="_blank" class="waze" id="nahariya-waze">
     <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
     <g>
...
<div class="map-icon">
  <a href="https://maps.app.goo.gl/Ch25oMUV51vef7xi9?g_st=iw" target="_blank" class="google" id="nahariya-google">
   <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
      viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
   <style type="text/css">
     .st22{fill:auto;}
...
<div class="map-icon">
 <a href="https://maps.apple.com/?ll=33.005998,35.088815&q=Dropped%20Pin&t=m" target="_blank" class="apple" id="nahariya-apple">
     <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
     <style type="text/css">
       .st20{fill:auto;}
...
<div class="vid-map">
  ...
  <div class="google-map">
    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d26767.319204011957!2d35.089201!3d33.006019!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x151dce560dc28965%3A0xa53ba3341fd46b7b!2sRecreation%20%26%20Sports%20Park%2C%20Nahariya%2C%20Israel!5e0!3m2!1sen!2sus!4v1684491620727!5m2!1sen!2sus" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
  </div>
</div>
