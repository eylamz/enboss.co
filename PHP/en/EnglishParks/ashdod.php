...
<head>
  ...
  <title>Ashdod | ENBOSS</title>
  <meta name="description" content="Ashdod Skatepark: Unleash Your Skills in Extreme Sports. Experience the heart-pounding action at Ashdod Skatepark, a hub for adrenaline enthusiasts. Discover diverse ramps, rails, and obstacles, and push your limits among a vibrant community of extreme sports enthusiasts. Join us for an unforgettable ride at Ashdod Skatepark.">

  <meta property="og:type" content="website">
  <meta property="og:title" content="Ashdod Skatepark">
  <meta property="og:image" content="http://www.enboss.co/images/ParkFav/ashdod.png">
  <meta property="og:image:secure_url" content="https://www.enboss.co/images/ParkFav/ashdod.png">
  <meta property="og:description" content="Unleash Your Skills in Extreme Sports at Ashdod Skatepark.">  
  ...
  <meta name="keywords" content="israel, skatepark, rollerblade, skate, hebrew, ashdod, roller, israeli, scoot, jerusalem, tel aviv, middle east, enboss.co">
...
<main class="parkMain body-move">
        ...
        <div class="slideshowDiv" >
          ...
          <div class="mySlides">
              <picture>
                  ...
                  <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/ashdod.webp">
                  <img src="/images/ParkGallery-webp/ashdod.webp" alt="ashdod skatepark" />
              </picture>
          ...
          <div class="mySlides">
            <picture>
              <source media="(max-width: 768px)" srcset="/images/Park768-webp/ashdod1.webp">
              <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/ashdod1.webp">
              <img src="/images/ParkGallery-webp/ashdod1.webp" alt="ashdod skatepark" />
          </picture>
          ...
          <div class="mySlides">
            <picture>
              <source media="(max-width: 768px)" srcset="/images/Park768-webp/ashdod2.webp">
              <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/ashdod2.webp">
              <img src="/images/ParkGallery-webp/ashdod2.webp" alt="ashdod skatepark" />
          </picture>
          ...
          <div class="mySlides">
                <picture>
                  <source media="(max-width: 768px)" srcset="/images/Park768-webp/ashdod3.webp">
                  <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/ashdod3.webp">
                  <img src="/images/ParkGallery-webp/ashdod3.webp" alt="ashdod skatepark" />
              </picture>
          ...
          <div class="mySlides">
            <picture>
              <source media="(max-width: 768px)" srcset="/images/Park768-webp/ashdod4.webp">
              <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/ashdod4.webp">
              <img src="/images/ParkGallery-webp/ashdod4.webp" alt="ashdod skatepark" />
          </picture>
          ...
          <div class="mySlides">
            <picture>
              <source media="(max-width: 768px)" srcset="/images/Park768-webp/ashdod5.webp">
              <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/ashdod5.webp">
              <img src="/images/ParkGallery-webp/ashdod5.webp" alt="ashdod skatepark" />
          </picture>
          ...
          <div class="mySlides">
            <picture>
              <source media="(max-width: 768px)" srcset="/images/Park768-webp/ashdod6.webp">
              <source media="(min-width: 769px)" srcset="/images/ParkGallery-webp/ashdod6.webp">
              <img src="/images/ParkGallery-webp/ashdod6.webp" alt="ashdod skatepark" />
          </picture>
  ...
  <div class="list-img">
    <ul>
        ...
        <li><strong>Sun-Thu :</strong> 15:00-22:45</li>
        <li><strong>Fri :</strong> 09:00-22:45</li>
        <li><strong>Sat and Holidays :</strong> 09:00-22:45</li>
        <hr>
        <li><strong>Address :</strong></li>
        <li>Ashdod Yam Park, Sderot Moshe Dayan, Ashdod.</li>
        <hr>
  ...
  <g>
    ...
    <br>
    <span><strong>Address :</strong><br>Ashdod Yam Park, Sderot Moshe Dayan, Ashdod.​</span>
  </div>
  <div class="social-maps"> 
    <div class="map-icon">
      <a href="https://waze.com/ul/hsv8suhjv8" target="_blank" class="waze" id="ashdod-waze">
       <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
       <g>
  ...
  <div class="map-icon">
    <a href="https://maps.app.goo.gl/pM54syD99GVvZXTK6?g_st=iw" target="_blank" class="google" id="ashdod-google">
     <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
     <style type="text/css">
       .st22{fill:auto;}
  ...
  <div class="map-icon">
    <a href="https://maps.apple.com/?address=Moshe%20Dayan%20Avenue,%20Ashdod,%20Israel&auid=7822423977414217147&ll=31.795552,34.636567&lsp=9902&q=%D7%A1%D7%A7%D7%99%D7%99%D7%98%D7%A4%D7%90%D7%A8%D7%A7&t=h" target="_blank" class="apple" id="ashdod-apple">
       <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
       <style type="text/css">
         .st20{fill:auto;}
  ...
  <div class="vid-map">
    ...
    <div class="google-map">
      <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3391.08754285523!2d34.636812!3d31.795364000000003!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1502a254bc757303%3A0x3f98c7969d66d75e!2sSkate%20Park%20in%20Ashdod%20Yam!5e0!3m2!1sen!2sus!4v1683413501939!5m2!1sen!2sus" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
  </div>
