...
<head>
  ...
  <title>Kiryat Ata | ENBOSS</title>
  <meta name="description" content="Unleash Your Thrill at Kiryat Ata Skatepark. Experience the perfect blend of tranquility and adrenaline in this remarkable skatepark. Get ready for an unforgettable adventure!">  

  <meta property="og:type" content="website">
  <meta property="og:title" content="Kiryat Ata Skatepark">
  <meta property="og:image" content="http://www.enboss.co/images/ParkFav/kiryat-ata.png">
  <meta property="og:image:secure_url" content="https://www.enboss.co/images/ParkFav/kiryat-ata.png">
  <meta property="og:description" content="Discover the Ultimate Adrenaline Playground. Unleash Your Thrill.">  
  <meta property="og:url" content="http://www.enboss.co/en/skateparks/kiryat-ata">
  <meta property="og:site_name" content="ENBOSS">
  <link rel="icon" href="/svg/EnbossFavIcon.svg">
  <meta property="og:locale" content="en_US">
  <meta name="keywords" content="israel, skatepark, rollerblade, skate, hebrew, kiryat ata, roller, israeli, scoot, jerusalem, tel aviv, middle east, enboss.co">
  ...
  <main class="parkMain body-move">
    <div class="parkHead">
      ...
      <div class="slideshowDiv" >
        ...
        <div class="mySlides">
          <picture>
            <source media="(max-width: 768px)" srcset="/images/Park768-webp/kiryat-ata1.webp">
            <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/kiryat-ata1.webp">
            <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/kiryat-ata1.webp">            
            <img src="/images/ParkGallery-webp/kiryat-ata1.webp" alt="kiryat ata skatepark" />
        </picture>
        ...
        <div class="mySlides">
          <picture>
            <source media="(max-width: 768px)" srcset="/images/Park768-webp/kiryat-ata2.webp">
            <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/kiryat-ata2.webp">
            <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/kiryat-ata2.webp">            
            <img src="/images/ParkGallery-webp/kiryat-ata2.webp" alt="kiryat ata skatepark" />
        </picture>
        ...
        <div class="mySlides">
          <picture>
            <source media="(max-width: 768px)" srcset="/images/Park768-webp/kiryat-ata3.webp">
            <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/kiryat-ata3.webp">
            <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/kiryat-ata3.webp">            
            <img src="/images/ParkGallery-webp/kiryat-ata3.webp" alt="kiryat ata skatepark" />
        </picture>
        ...
        <div class="mySlides">
          <picture>
            <source media="(max-width: 768px)" srcset="/images/Park768-webp/kiryat-ata4.webp">
            <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/kiryat-ata4.webp">
            <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/kiryat-ata4.webp">
            <img src="/images/ParkGallery-webp/kiryat-ata4.webp" alt="kiryat ata skatepark" />
        </picture>
        ...
        <div class="mySlides">
          <picture>
            <source media="(max-width: 768px)" srcset="/images/Park768-webp/kiryat-ata5.webp">
            <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/kiryat-ata5.webp">
            <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/kiryat-ata5.webp">            
            <img src="/images/ParkGallery-webp/kiryat-ata5.webp" alt="kiryat ata skatepark" />
        </picture>
        ...
        <div class="mySlides">
          <picture>
            <source media="(max-width: 768px)" srcset="/images/Park768-webp/kiryat-ata6.webp">
            <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/kiryat-ata6.webp">
            <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/kiryat-ata6.webp">            
            <img src="/images/ParkGallery-webp/kiryat-ata6.webp" alt="kiryat ata skatepark" />
        </picture>
        ...
        <div class="mySlides">
          <picture>
            <source media="(max-width: 768px)" srcset="/images/Park768-webp/kiryat-ata7.webp">
            <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/kiryat-ata7.webp">
            <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/kiryat-ata7.webp">            
            <img src="/images/ParkGallery-webp/kiryat-ata7.webp" alt="kiryat ata skatepark" />
        </picture>
        ...
        <div class="mySlides">
          <picture>
            <source media="(max-width: 768px)" srcset="/images/Park768-webp/kiryat-ata8.webp">
            <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/kiryat-ata8.webp">
            <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/kiryat-ata8.webp">            
            <img src="/images/ParkGallery-webp/kiryat-ata8.webp" alt="kiryat ata skatepark" />
        </picture>
        ...
        <div class="mySlides">
          <picture>
            <source media="(max-width: 768px)" srcset="/images/Park768-webp/kiryat-ata9.webp">
            <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/kiryat-ata9.webp">
            <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/kiryat-ata9.webp">            
            <img src="/images/ParkGallery-webp/kiryat-ata9.webp" alt="kiryat ata skatepark" />
        </picture>
        ...
        <div class="mySlides">
          <picture>
            <source media="(max-width: 768px)" srcset="/images/Park768-webp/kiryat-ata10.webp">
            <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/kiryat-ata10.webp">
            <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/kiryat-ata10.webp">            
            <img src="/images/ParkGallery-webp/kiryat-ata10.webp" alt="kiryat ata skatepark" />
        </picture>
        ...
        <div class="mySlides">
          <picture>
            <source media="(max-width: 768px)" srcset="/images/Park768-webp/kiryat-ata11.webp">
            <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/kiryat-ata11.webp">
            <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/kiryat-ata11.webp">            
            <img src="/images/ParkGallery-webp/kiryat-ata11.webp" alt="kiryat ata skatepark" />
        </picture>
...
<div class="list-img">
  <ul>
    ...
    <li><strong>Mon-Thu :</strong> 08:00-23:00</li>
    <li><strong>Fri :</strong> 08:00-17:00</li>
    <li><strong>Sat and Holidays :</strong> 08:00-23:00</li>
    <hr>
    <li><strong>Address :</strong></li>
    <li>The Sports Park, Natan Spritzer St, Kiryat Ata</li>
    <hr>
    <li><strong>Admission fee :</strong></li>
    <li>60₪ for an adult, 30₪ for a young person.</li>
    <hr>
    <li><strong>* </strong>Bike riders are not allowed to enter.</li>
    <li><strong>* </strong>Free entry for Kiryat Ata residents.</li>
    <hr>
...
<g>
  ...
  <br>
  <span><strong>Address :</strong><br>The Sports Park, Natan Spritzer St, Kiryat Ata. </span>
</div>
<div class="social-maps"> 
  <div class="map-icon">
  <a href="https://ul.waze.com/ul?preview_venue_id=23003464.230165713.38360&navigate=yes&utm_campaign=default&utm_source=waze_website&utm_medium=lm_share_location" target="_blank" class="waze" id="kiryat-ata-waze">
     <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
     <g>
...
<div class="map-icon">
  <a href="https://goo.gl/maps/Cw4XL7Fsm3xLtnAb9" target="_blank" class="google" id="kiryat-ata-google">
   <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
      viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
   <style type="text/css">
     .st22{fill:auto;}
...
<div class="map-icon">
 <a href="https://maps.apple.com/?ll=32.814262,35.122913&q=Dropped%20Pin&t=m" target="_blank" class="apple" id="kiryat-ata-apple">
     <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
     <style type="text/css">
       .st20{fill:auto;}
...
<div class="vid-map">
  ...
  <div class="google-map">
    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d26825.34168874098!2d35.122415!3d32.814321!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x151db6a17420f5af%3A0xefc840f7c2afbf18!2sLoki%20Park!5e0!3m2!1sen!2sus!4v1682852319568!5m2!1sen!2sus" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>  </div>
  </div>
</div>
