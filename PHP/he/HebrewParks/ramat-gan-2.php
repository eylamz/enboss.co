...
<head>
  ...
  <title>רמת גן - פארק לאומי | ENBOSS </title>
  <meta name="description" content="חווה ריגושים בסקייטפארק רמת גן. בין אם אתה רוכב סקייטבורד, רולרבליידר או BMX, הסקייטפארק החדשני ברמת גן הוא מגרש המשחקים האולטימטיבי שלכם, כבשו את הרמפות, החליקו על האלמנטים ופרצו את הגבולות שלכם עם קהילה גדולה של ספורטאים נלהבים, עם המתקנים ברמה עולמית ומכשולים מאתגרים, סקייטפארק רמת גן הוא המקום בו מתגשמים חלומות ספורט האקסטרים שלכם.">
  <meta property="og:type" content="website">
  <meta property="og:title" content="סקייטפארק רמת גן">
...
<link rel="StyleSheet" href="/css/HebrewCSS/hebrew-header.css" />
           ...
           <link rel="StyleSheet" href="/css/HebrewCSS/HebrewParks/Primary/PrimaryBlueVid.css" />
...
<body class="parkBody">
  ...
  <h1 class="deskH1">רמת גן - פארק לאומי</h1>
  <h1 id="mobileH1">רמת גן<br><strong>פארק לאומי</strong></h1>    
        <!-- slideshow html -->
      <style>
        .slideshowDiv img {
            filter: saturate(1.5);
  ...
  <div class="list-img">
    <ul>
      ...
      <li>משקיעת השמש עד 00:00.</li>
      <hr>
      <li><strong>כתובת :</strong></li>
      <li>שדרת הצבי 3, רמת גן.</li>
      <hr>
      <li><strong>* </strong>הכניסה לרוכבי אופניים אסורה.</li>
      <hr>
  ...
  <g>
    ...
    <br>
    <span><strong>כתובת :</strong><br>שדרת הצבי 3, רמת גן.</span>
  </div>
