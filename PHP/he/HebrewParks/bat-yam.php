...
<head>
  ...
  <title>בת ים | ENBOSS </title>
  <meta property="og:type" content="website">
  <meta property="og:title" content="סקייטפארק בת ים">
  ...
  <meta property="og:url" content="http://www.enboss.co/he/skateparks/bat-yam">
  ...
  <meta name="keywords" content="ישראל, סקייטפארק, רולרבלייד, סקייט, עברית, בת ים, רולר, ישראלי, קרוקינט, המזרח התיכון, enboss.co">
...
<body class="parkBody">
  ...
  <div class="list-img">
    <ul>
      ...
      <li>לא קיימת כתובת להגעה, יש להגיע בעזרת קישורי הניווט המופיעים מטה.</li>
      <hr>
  ...
  <g>
    ...
    <br>
    <span><strong>כתובת :</strong><br>לא קיימת כתובת להגעה, יש להגיע בעזרת קישורי הניווט המופיעים מטה.</span>
  </div>
