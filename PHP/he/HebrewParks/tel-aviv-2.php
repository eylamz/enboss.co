...
<head>
  ...
  <title>תל אביב - רמת החייל | ENBOSS </title>
  ...
  <meta property="og:title" content="סקייטפארק תל אביב - רמת החייל">
  <meta property="og:image" content="http://www.enboss.co/images/ParkFav/tel-aviv(2).png">
  <meta property="og:image:secure_url" content="https://www.enboss.co/images/ParkFav/tel-aviv(2).png">
  <meta property="og:description" content="פרצו גבולות וחוו התרגשות בסקייטפארק מלהיב במיוחד ">  
  <meta property="og:url" content="http://www.enboss.co/he/skateparks/tel-aviv-2">
  <meta property="og:site_name" content="ENBOSS">
  <link rel="icon" href="/svg/EnbossFavIcon.svg">  
  <meta property="og:locale" content="he_IL">
  <meta name="keywords" content="ישראל, סקייטפארק, רולרבלייד, סקייט, עברית, רמת גן, רולר, פארק, רמת, החייל, ישראלי, קרוקינט, המזרח התיכון, enboss.co">
...
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
          ...
          <link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;400;500;600;700;800&family=Poppins:wght@100;200;300;400;500;600;700;800;900&family=Public+Sans:wght@100;200;300;400;500;600;700;800;900&display=swap" rel="stylesheet">
           ...
           <link rel="StyleSheet" href="/css/HebrewCSS/HebrewParks/Primary/PrimaryBlue.css?v=1.002" />
...
<body class="parkBody">
  ...
  <h1 class="deskH1">תל אביב - רמת החייל</h1>
  <h1 id="mobileH1">תל אביב<br><strong>רמת החייל</strong></h1>    
      <!-- slideshow html -->
      <style>
        .slideshowDiv img {
            filter: saturate(1.5);
      ...
      <div class="slideshowDiv" >
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/tel-aviv(2)2.webp">
                <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/tel-aviv(2)2.webp">
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/tel-aviv(2)3.webp">
                <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/tel-aviv(2)3.webp">
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/tel-aviv(2)4.webp">
                <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/tel-aviv(2)4.webp">
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/tel-aviv(2)5.webp">
                <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/tel-aviv(2)5.webp">
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/tel-aviv(2)6.webp">
                <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/tel-aviv(2)6.webp">
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/tel-aviv(2)7.webp">
                <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/tel-aviv(2)7.webp">
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/tel-aviv(2)8.webp">
                <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/tel-aviv(2)8.webp">
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/tel-aviv(2)9.webp">
                <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/tel-aviv(2)9.webp">
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/tel-aviv(2)10.webp">
                <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/tel-aviv(2)10.webp">
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/tel-aviv(2)11.webp">
                <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/tel-aviv(2)11.webp">
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/tel-aviv(2)12.webp">
                <source media="(max-width: 1199px)" srcset="/images/ParkGallery-webp/tel-aviv(2)12.webp">
  ...
  <div class="list-img">
    <ul>
      ...
      <li><strong>כל השבוע :</strong> 09:00-22:30</li>
      <hr>
      <li><strong>כתובת :</strong></li>
      <li>רחוב הברזל 38, תל אביב.</li>
      <br>
      <li><strong>* </strong>מקיפים את המבנה לאורך רחוב 2390 עד לכניסה לפארק גני יהושע.</li>
      <hr>
      <li><strong>* </strong>הכניסה לרוכבי אופניים אסורה.</li>
      <hr>
      <li>נפתח בשנת 2024.</li>
    </ul>
  ...
  <g>
    ...
    <br>
    <span><strong>כתובת :</strong><br>רחוב הארד, תל אביב</span>
  </div>
  <div class="social-maps"> 
  <div class="map-icon">
  <a href="https://waze.com/ul/hsv8y8v7ws" target="_blank" class="waze" id="tel-aviv-2-waze">
     <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
     <g>
...
<div class="map-icon">
  <a href="https://maps.app.goo.gl/HXW7aV83q13Tyqii9" target="_blank" class="google" id="tel-aviv-2-google">
   <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
      viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
   <style type="text/css">
     .st22{fill:auto;}
...
<div class="map-icon">
 <a href="https://maps.apple.com/?ll=32.109778,34.843328&q=Dropped%20Pin&t=h" target="_blank" class="apple" id="tel-aviv-2-apple">
     <svg version="1.1" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 187.7 190.5" style="enable-background:new 0 0 187.7 190.5;" xml:space="preserve">
     <style type="text/css">
       .st20{fill:auto;}
...
<div class="vid-map">
    ...
    <iframe src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d844.872040079834!2d34.843342426351605!3d32.110116381838786!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMzLCsDA2JzM1LjIiTiAzNMKwNTAnMzYuMCJF!5e0!3m2!1sen!2sil!4v1705167236389!5m2!1sen!2sil" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
    </div>
 <!--   otherParks Section    -->
