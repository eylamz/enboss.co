...
<head>
  ...
  <title>מצפה רמון | ENBOSS</title>
  <meta property="og:type" content="website">
  <meta property="og:title" content="סקייטפארק מצפה רמון">
  <meta property="og:image" content="http://www.enboss.co/images/ParkFav/mitzpe-ramon.png">
  <meta property="og:image:secure_url" content="https://www.enboss.co/images/ParkFav/mitzpe-ramon.png">
...
<div class="parkHead">
  <h1>מצפה רמון</h1>
      ...
      <div class="slideshowDiv" >
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/mitzpe-ramon.webp">
                <source media="(max-width: 769px)" srcset="/images/ParkGallery-webp/mitzpe-ramon.webp">
                <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/mitzpe-ramon.webp">
                <img src="/images/ParkGallery-webp/mitzpe-ramon.webp" alt="dimona skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/mitzpe-ramon1.webp">
                <source media="(max-width: 769px)" srcset="/images/ParkGallery-webp/mitzpe-ramon1.webp">
                <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/mitzpe-ramon1.webp">
                <img src="/images/ParkGallery-webp/mitzpe-ramon1.webp" alt="dimona skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/mitzpe-ramon2.webp">
                <source media="(max-width: 769px)" srcset="/images/ParkGallery-webp/mitzpe-ramon2.webp">
                <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/mitzpe-ramon2.webp">
                <img src="/images/ParkGallery-webp/mitzpe-ramon2.webp" alt="dimona skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/mitzpe-ramon3.webp">
                <source media="(max-width: 769px)" srcset="/images/ParkGallery-webp/mitzpe-ramon3.webp">
                <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/mitzpe-ramon3.webp">
                <img src="/images/ParkGallery-webp/mitzpe-ramon3.webp" alt="dimona skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/mitzpe-ramon4.webp">
                <source media="(max-width: 769px)" srcset="/images/ParkGallery-webp/mitzpe-ramon4.webp">
                <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/mitzpe-ramon4.webp">
                <img src="/images/ParkGallery-webp/mitzpe-ramon4.webp" alt="dimona skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/mitzpe-ramon5.webp">
                <source media="(max-width: 769px)" srcset="/images/ParkGallery-webp/mitzpe-ramon5.webp">
                <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/mitzpe-ramon5.webp">
                <img src="/images/ParkGallery-webp/mitzpe-ramon5.webp" alt="dimona skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/mitzpe-ramon6.webp">
                <source media="(max-width: 769px)" srcset="/images/ParkGallery-webp/mitzpe-ramon6.webp">
                <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/mitzpe-ramon6.webp">
                <img src="/images/ParkGallery-webp/mitzpe-ramon6.webp" alt="dimona skatepark" />
            </picture>
        ...
        <div class="mySlides">
            <picture>
                <source media="(max-width: 768px)" srcset="/images/Park768-webp/mitzpe-ramon7.webp">
                <source media="(max-width: 769px)" srcset="/images/ParkGallery-webp/mitzpe-ramon7.webp">
                <source media="(min-width: 1200px)" srcset="/images/Park1500-webp/mitzpe-ramon7.webp">
                <img src="/images/ParkGallery-webp/mitzpe-ramon7.webp" alt="dimona skatepark" />
            </picture>
  ...
  <div class="list-img">
    <ul>
      ...
      <li>שדרות דוד בן גוריון 16, מצפה רמון.</li>
      <hr>
  ...
  <g>
    ...
    <br>
    <span><strong>כתובת :</strong><br>שדרות דוד בן גוריון 16, מצפה רמון.</span>
  </div>
 ...
 <div class="vid-map">
  <div class="iconBox2">
    <iframe width="560" height="315" src="https://www.youtube.com/embed/Z4M9LpLQCAM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
  </div>
  <div class="google-map">
    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d27470.647919863666!2d34.801306!3d30.61053!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1501f248a990edef%3A0x630851499da5d015!2sSderot%20David%20Ben%20Gurion%2016%2C%20Mitzpe%20Ramon%2C%20Israel!5e0!3m2!1sen!2sus!4v1684738003856!5m2!1sen!2sus" width="560" height="315" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>  </div>
</div>
